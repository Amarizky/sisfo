...
$master_wilayah_kecamatan_search = NULL; // Initialize page object first

class cmaster_wilayah_kecamatan_search extends cmaster_wilayah_kecamatan {
	...
	// Page object name
	var $PageObjName = 'master_wilayah_kecamatan_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "master_wilayah_kecamatanlist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->Kecamatan); // Kecamatan
	...
	function LoadSearchValues() {
		...
		// Kecamatan
		$this->Kecamatan->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_Kecamatan"));
		$this->Kecamatan->AdvancedSearch->SearchOperator = $objForm->GetValue("z_Kecamatan");
	}
	...
	function RenderRow() {
		...
		$this->Kecamatan->ViewCustomAttributes = "";
			...
			$this->KecamatanID->EditValue = ew_HtmlEncode($this->KecamatanID->AdvancedSearch->SearchValue);
			...
			$this->Kecamatan->EditValue = ew_HtmlEncode($this->Kecamatan->AdvancedSearch->SearchValue);
...
// Create page object
if (!isset($master_wilayah_kecamatan_search)) $master_wilayah_kecamatan_search = new cmaster_wilayah_kecamatan_search();

// Page init
$master_wilayah_kecamatan_search->Page_Init();

// Page main
$master_wilayah_kecamatan_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_wilayah_kecamatan_search->Page_Render();
?>
...
<?php if ($master_wilayah_kecamatan_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fmaster_wilayah_kecamatansearch = new ew_Form("fmaster_wilayah_kecamatansearch", "search");
<?php } else { ?>
var CurrentForm = fmaster_wilayah_kecamatansearch = new ew_Form("fmaster_wilayah_kecamatansearch", "search");
<?php } ?>

// Form_CustomValidate event
fmaster_wilayah_kecamatansearch.Form_CustomValidate = 
...
fmaster_wilayah_kecamatansearch.ValidateRequired = true;
<?php } else { ?>
fmaster_wilayah_kecamatansearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_wilayah_kecamatansearch.Lists["x_KabupatenKotaID"] = {"LinkField":"x_KabupatenKotaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_KabupatenKota","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_kabupatenkota"};

// Form object for search
// Validate function for search

fmaster_wilayah_kecamatansearch.Validate = function(fobj) {
...
<?php } ?>
<?php $master_wilayah_kecamatan_search->ShowPageHeader(); ?>
<?php
$master_wilayah_kecamatan_search->ShowMessage();
?>
<form name="fmaster_wilayah_kecamatansearch" id="fmaster_wilayah_kecamatansearch" class="<?php echo $master_wilayah_kecamatan_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_wilayah_kecamatan_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_wilayah_kecamatan_search->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_wilayah_kecamatan_search->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_wilayah_kecamatan_search->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_wilayah_kecamatansearch" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
<?php if ($master_wilayah_kecamatan->KecamatanID->Visible) { // KecamatanID ?>
<?php if (ew_IsMobile() || $master_wilayah_kecamatan_search->IsModal) { ?>
	<div id="r_KecamatanID" class="form-group">
		<label for="x_KecamatanID" class="<?php echo $master_wilayah_kecamatan_search->SearchLabelClass ?>"><span id="elh_master_wilayah_kecamatan_KecamatanID"><?php echo $master_wilayah_kecamatan->KecamatanID->FldCaption() ?></span>	
		...
		<div class="<?php echo $master_wilayah_kecamatan_search->SearchRightColumnClass ?>"><div<?php echo $master_wilayah_kecamatan->KecamatanID->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_KecamatanID">
		<td><span id="elh_master_wilayah_kecamatan_KecamatanID"><?php echo $master_wilayah_kecamatan->KecamatanID->FldCaption() ?></span></td>
...
<?php if (ew_IsMobile() || $master_wilayah_kecamatan_search->IsModal) { ?>
	<div id="r_KabupatenKotaID" class="form-group">
		<label for="x_KabupatenKotaID" class="<?php echo $master_wilayah_kecamatan_search->SearchLabelClass ?>"><span id="elh_master_wilayah_kecamatan_KabupatenKotaID"><?php echo $master_wilayah_kecamatan->KabupatenKotaID->FldCaption() ?></span>	
		...
		<div class="<?php echo $master_wilayah_kecamatan_search->SearchRightColumnClass ?>"><div<?php echo $master_wilayah_kecamatan->KabupatenKotaID->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_KabupatenKotaID">
		<td><span id="elh_master_wilayah_kecamatan_KabupatenKotaID"><?php echo $master_wilayah_kecamatan->KabupatenKotaID->FldCaption() ?></span></td>
...
<?php if (ew_IsMobile() || $master_wilayah_kecamatan_search->IsModal) { ?>
	<div id="r_Kecamatan" class="form-group">
		<label for="x_Kecamatan" class="<?php echo $master_wilayah_kecamatan_search->SearchLabelClass ?>"><span id="elh_master_wilayah_kecamatan_Kecamatan"><?php echo $master_wilayah_kecamatan->Kecamatan->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Kecamatan" id="z_Kecamatan" value="LIKE"></p>
		</label>
		<div class="<?php echo $master_wilayah_kecamatan_search->SearchRightColumnClass ?>"><div<?php echo $master_wilayah_kecamatan->Kecamatan->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Kecamatan">
		<td><span id="elh_master_wilayah_kecamatan_Kecamatan"><?php echo $master_wilayah_kecamatan->Kecamatan->FldCaption() ?></span></td>
		<td><span class="ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Kecamatan" id="z_Kecamatan" value="LIKE"></span></td>
...
<script type="text/javascript">
fmaster_wilayah_kecamatansearch.Init();
</script>
<?php
$master_wilayah_kecamatan_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_wilayah_kecamatan_search->Page_Terminate();
?>
