...
$master_mk_view = NULL; // Initialize page object first

class cmaster_mk_view extends cmaster_mk {
	...
	// Page object name
	var $PageObjName = 'master_mk_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["MKID"] <> "") {
				...
				$sReturnUrl = "master_mklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "master_mklist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "master_mklist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($master_mk_view)) $master_mk_view = new cmaster_mk_view();

// Page init
$master_mk_view->Page_Init();

// Page main
$master_mk_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_mk_view->Page_Render();
?>
...
var CurrentForm = fmaster_mkview = new ew_Form("fmaster_mkview", "view");

// Form_CustomValidate event
fmaster_mkview.Form_CustomValidate = 
...
fmaster_mkview.ValidateRequired = true;
<?php } else { ?>
fmaster_mkview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_mkview.Lists["x_KampusID"] = {"LinkField":"x_KampusID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_kampus"};
fmaster_mkview.Lists["x_ProdiID"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_KurikulumID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
fmaster_mkview.Lists["x_KurikulumID"] = {"LinkField":"x_KurikulumID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kurikulum"};
fmaster_mkview.Lists["x_Tingkat"] = {"LinkField":"x_Tingkat","Ajax":true,"AutoFill":false,"DisplayFields":["x_Tingkat","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kelas"};
fmaster_mkview.Lists["x_Sesi"] = {"LinkField":"x_Sesi","Ajax":true,"AutoFill":false,"DisplayFields":["x_NamaSesi","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_sesi"};
fmaster_mkview.Lists["x_Wajib"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_mkview.Lists["x_Wajib"].Options = <?php echo json_encode($master_mk->Wajib->Options()) ?>;
fmaster_mkview.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_mkview.Lists["x_NA"].Options = <?php echo json_encode($master_mk->NA->Options()) ?>;
...
<?php if ($master_mk->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$master_mk_view->IsModal) { ?>
<?php if ($master_mk->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $master_mk_view->ExportOptions->Render("body") ?>
<?php
	foreach ($master_mk_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$master_mk_view->IsModal) { ?>
<?php if ($master_mk->Export == "") { ?>
...
<?php } ?>
<?php $master_mk_view->ShowPageHeader(); ?>
<?php
$master_mk_view->ShowMessage();
?>
<form name="fmaster_mkview" id="fmaster_mkview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_mk_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_mk_view->Token ?>">
<?php } ?>
...
<?php if ($master_mk->MKID->Visible) { // MKID ?>
	<tr id="r_MKID">
		...
		<td data-name="MKID"<?php echo $master_mk->MKID->CellAttributes() ?>>
<span id="el_master_mk_MKID">
<span<?php echo $master_mk->MKID->ViewAttributes() ?>>
<?php echo $master_mk->MKID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($master_mk->KampusID->Visible) { // KampusID ?>
	<tr id="r_KampusID">
		...
		<td data-name="KampusID"<?php echo $master_mk->KampusID->CellAttributes() ?>>
<span id="el_master_mk_KampusID">
<span<?php echo $master_mk->KampusID->ViewAttributes() ?>>
<?php echo $master_mk->KampusID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($master_mk->ProdiID->Visible) { // ProdiID ?>
	<tr id="r_ProdiID">
		...
		<td data-name="ProdiID"<?php echo $master_mk->ProdiID->CellAttributes() ?>>
<span id="el_master_mk_ProdiID">
<span<?php echo $master_mk->ProdiID->ViewAttributes() ?>>
<?php echo $master_mk->ProdiID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($master_mk->KurikulumID->Visible) { // KurikulumID ?>
	<tr id="r_KurikulumID">
		...
		<td data-name="KurikulumID"<?php echo $master_mk->KurikulumID->CellAttributes() ?>>
<span id="el_master_mk_KurikulumID">
<span<?php echo $master_mk->KurikulumID->ViewAttributes() ?>>
<?php echo $master_mk->KurikulumID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_mk->MKKode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_mk->Nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_mk->Singkatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_mk->Tingkat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_mk->Sesi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_mk->Wajib->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($master_mk->Deskripsi->Visible) { // Deskripsi ?>
	<tr id="r_Deskripsi">
		...
		<td data-name="Deskripsi"<?php echo $master_mk->Deskripsi->CellAttributes() ?>>
<span id="el_master_mk_Deskripsi">
<span<?php echo $master_mk->Deskripsi->ViewAttributes() ?>>
<?php echo $master_mk->Deskripsi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($master_mk->Creator->Visible) { // Creator ?>
	<tr id="r_Creator">
		<td><span id="elh_master_mk_Creator"><?php echo $master_mk->Creator->FldCaption() ?></span></td>
		<td data-name="Creator"<?php echo $master_mk->Creator->CellAttributes() ?>>
<span id="el_master_mk_Creator">
<span<?php echo $master_mk->Creator->ViewAttributes() ?>>
<?php echo $master_mk->Creator->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($master_mk->CreateDate->Visible) { // CreateDate ?>
	<tr id="r_CreateDate">
		<td><span id="elh_master_mk_CreateDate"><?php echo $master_mk->CreateDate->FldCaption() ?></span></td>
		<td data-name="CreateDate"<?php echo $master_mk->CreateDate->CellAttributes() ?>>
<span id="el_master_mk_CreateDate">
<span<?php echo $master_mk->CreateDate->ViewAttributes() ?>>
<?php echo $master_mk->CreateDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($master_mk->Editor->Visible) { // Editor ?>
	<tr id="r_Editor">
		<td><span id="elh_master_mk_Editor"><?php echo $master_mk->Editor->FldCaption() ?></span></td>
		<td data-name="Editor"<?php echo $master_mk->Editor->CellAttributes() ?>>
<span id="el_master_mk_Editor">
<span<?php echo $master_mk->Editor->ViewAttributes() ?>>
<?php echo $master_mk->Editor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($master_mk->EditDate->Visible) { // EditDate ?>
	<tr id="r_EditDate">
		<td><span id="elh_master_mk_EditDate"><?php echo $master_mk->EditDate->FldCaption() ?></span></td>
		<td data-name="EditDate"<?php echo $master_mk->EditDate->CellAttributes() ?>>
<span id="el_master_mk_EditDate">
<span<?php echo $master_mk->EditDate->ViewAttributes() ?>>
<?php echo $master_mk->EditDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_mk->NA->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
