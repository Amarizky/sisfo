...
$kurikulum_search = NULL; // Initialize page object first

class ckurikulum_search extends ckurikulum {
	...
	// Page object name
	var $PageObjName = 'kurikulum_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "kurikulumlist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->KurikulumKode); // KurikulumKode
		$this->BuildSearchUrl($sSrchUrl, $this->Nama); // Nama
		$this->BuildSearchUrl($sSrchUrl, $this->JmlSesi); // JmlSesi
	...
	function LoadSearchValues() {
		...
		// KurikulumKode
		$this->KurikulumKode->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_KurikulumKode"));
		$this->KurikulumKode->AdvancedSearch->SearchOperator = $objForm->GetValue("z_KurikulumKode");
		...
		// JmlSesi
		$this->JmlSesi->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_JmlSesi"));
		$this->JmlSesi->AdvancedSearch->SearchOperator = $objForm->GetValue("z_JmlSesi");
	...
	function RenderRow() {
		...
		$this->NA->ViewCustomAttributes = "";
			...
			$this->KurikulumKode->EditValue = ew_HtmlEncode($this->KurikulumKode->AdvancedSearch->SearchValue);
			...
			$this->JmlSesi->EditValue = ew_HtmlEncode($this->JmlSesi->AdvancedSearch->SearchValue);
	...
	function ValidateSearch() {
		...
		if (!EW_SERVER_VALIDATE)
			return TRUE;
		if (!ew_CheckInteger($this->JmlSesi->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->JmlSesi->FldErrMsg());
		}
...
// Create page object
if (!isset($kurikulum_search)) $kurikulum_search = new ckurikulum_search();

// Page init
$kurikulum_search->Page_Init();

// Page main
$kurikulum_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$kurikulum_search->Page_Render();
?>
...
<?php if ($kurikulum_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fkurikulumsearch = new ew_Form("fkurikulumsearch", "search");
<?php } else { ?>
var CurrentForm = fkurikulumsearch = new ew_Form("fkurikulumsearch", "search");
<?php } ?>

// Form_CustomValidate event
fkurikulumsearch.Form_CustomValidate = 
...
fkurikulumsearch.ValidateRequired = true;
<?php } else { ?>
fkurikulumsearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fkurikulumsearch.Lists["x_KampusID"] = {"LinkField":"x_KampusID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_kampus"};
fkurikulumsearch.Lists["x_ProdiID"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
fkurikulumsearch.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fkurikulumsearch.Lists["x_NA"].Options = <?php echo json_encode($kurikulum->NA->Options()) ?>;

// Form object for search
// Validate function for search

fkurikulumsearch.Validate = function(fobj) {
...
<?php } ?>
<?php $kurikulum_search->ShowPageHeader(); ?>
<?php
$kurikulum_search->ShowMessage();
?>
<form name="fkurikulumsearch" id="fkurikulumsearch" class="<?php echo $kurikulum_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($kurikulum_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $kurikulum_search->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$kurikulum_search->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $kurikulum_search->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_kurikulumsearch" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
<?php if ($kurikulum->KampusID->Visible) { // KampusID ?>
<?php if (ew_IsMobile() || $kurikulum_search->IsModal) { ?>
	<div id="r_KampusID" class="form-group">
		<label for="x_KampusID" class="<?php echo $kurikulum_search->SearchLabelClass ?>"><span id="elh_kurikulum_KampusID"><?php echo $kurikulum->KampusID->FldCaption() ?></span>	
		...
		<div class="<?php echo $kurikulum_search->SearchRightColumnClass ?>"><div<?php echo $kurikulum->KampusID->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $kurikulum_search->IsModal) { ?>
	<div id="r_ProdiID" class="form-group">
		<label for="x_ProdiID" class="<?php echo $kurikulum_search->SearchLabelClass ?>"><span id="elh_kurikulum_ProdiID"><?php echo $kurikulum->ProdiID->FldCaption() ?></span>	
		...
		<div class="<?php echo $kurikulum_search->SearchRightColumnClass ?>"><div<?php echo $kurikulum->ProdiID->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $kurikulum_search->IsModal) { ?>
	<div id="r_KurikulumKode" class="form-group">
		<label for="x_KurikulumKode" class="<?php echo $kurikulum_search->SearchLabelClass ?>"><span id="elh_kurikulum_KurikulumKode"><?php echo $kurikulum->KurikulumKode->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_KurikulumKode" id="z_KurikulumKode" value="LIKE"></p>
		</label>
		<div class="<?php echo $kurikulum_search->SearchRightColumnClass ?>"><div<?php echo $kurikulum->KurikulumKode->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_KurikulumKode">
		...
		<td><span class="ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_KurikulumKode" id="z_KurikulumKode" value="LIKE"></span></td>
...
<?php if (ew_IsMobile() || $kurikulum_search->IsModal) { ?>
	<div id="r_Nama" class="form-group">
		<label for="x_Nama" class="<?php echo $kurikulum_search->SearchLabelClass ?>"><span id="elh_kurikulum_Nama"><?php echo $kurikulum->Nama->FldCaption() ?></span>	
		...
		<div class="<?php echo $kurikulum_search->SearchRightColumnClass ?>"><div<?php echo $kurikulum->Nama->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $kurikulum_search->IsModal) { ?>
	<div id="r_JmlSesi" class="form-group">
		<label for="x_JmlSesi" class="<?php echo $kurikulum_search->SearchLabelClass ?>"><span id="elh_kurikulum_JmlSesi"><?php echo $kurikulum->JmlSesi->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_JmlSesi" id="z_JmlSesi" value="="></p>
		</label>
		<div class="<?php echo $kurikulum_search->SearchRightColumnClass ?>"><div<?php echo $kurikulum->JmlSesi->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_JmlSesi">
		...
		<td><span class="ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_JmlSesi" id="z_JmlSesi" value="="></span></td>
...
<?php if (ew_IsMobile() || $kurikulum_search->IsModal) { ?>
	<div id="r_NA" class="form-group">
		<label class="<?php echo $kurikulum_search->SearchLabelClass ?>"><span id="elh_kurikulum_NA"><?php echo $kurikulum->NA->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_NA" id="z_NA" value="="></p>
		</label>
		<div class="<?php echo $kurikulum_search->SearchRightColumnClass ?>"><div<?php echo $kurikulum->NA->CellAttributes() ?>>
...
<script type="text/javascript">
fkurikulumsearch.Init();
</script>
<?php
$kurikulum_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$kurikulum_search->Page_Terminate();
?>
