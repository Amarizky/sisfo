...
$khs_view = NULL; // Initialize page object first

class ckhs_view extends ckhs {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["KHSID"] <> "") {
			$this->RecKey["KHSID"] = $_GET["KHSID"];
			$KeyUrl .= "&amp;KHSID=" . urlencode($this->RecKey["KHSID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["KHSID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["KHSID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["KHSID"] <> "") {
				...
				$this->RecKey["KHSID"] = $this->KHSID->QueryStringValue;
			} elseif (@$_POST["KHSID"] <> "") {
				$this->KHSID->setFormValue($_POST["KHSID"]);
				$this->RecKey["KHSID"] = $this->KHSID->FormValue;
			} else {
				$sReturnUrl = "khslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "khslist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "khslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_khs\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_khs',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fkhsview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($khs_view)) $khs_view = new ckhs_view();
...
var CurrentForm = fkhsview = new ew_Form("fkhsview", "view");

// Form_CustomValidate event
fkhsview.Form_CustomValidate = 
...
fkhsview.ValidateRequired = true;
<?php } else { ?>
fkhsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fkhsview.Lists["x_ProdiID"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_TahunID","x_Tingkat","x_Kelas","x_StudentID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
fkhsview.Lists["x_TahunID"] = {"LinkField":"x_TahunID","Ajax":true,"AutoFill":false,"DisplayFields":["x_TahunID","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"tahun"};
fkhsview.Lists["x_Sesi[]"] = {"LinkField":"x_Sesi","Ajax":true,"AutoFill":false,"DisplayFields":["x_NamaSesi","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_sesi"};
fkhsview.Lists["x_Tingkat"] = {"LinkField":"x_Tingkat","Ajax":true,"AutoFill":false,"DisplayFields":["x_Tingkat","","",""],"ParentFields":[],"ChildFields":["x_Kelas"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kelas"};
fkhsview.Lists["x_Kelas"] = {"LinkField":"x_KelasID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kelas"};
fkhsview.Lists["x_StudentID"] = {"LinkField":"x_StudentID","Ajax":true,"AutoFill":false,"DisplayFields":["x_StudentID","x_Nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"student"};
fkhsview.Lists["x_StatusStudentID"] = {"LinkField":"x_StatusStudentID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_statusstudent"};
fkhsview.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fkhsview.Lists["x_NA"].Options = <?php echo json_encode($khs->NA->Options()) ?>;
...
<?php if ($khs->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$khs_view->IsModal) { ?>
<?php if ($khs->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $khs_view->ExportOptions->Render("body") ?>
<?php
	foreach ($khs_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$khs_view->IsModal) { ?>
<?php if ($khs->Export == "") { ?>
...
<?php } ?>
<?php $khs_view->ShowPageHeader(); ?>
<?php
$khs_view->ShowMessage();
?>
<form name="fkhsview" id="fkhsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($khs_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $khs_view->Token ?>">
<?php } ?>
...
<?php if ($khs->KHSID->Visible) { // KHSID ?>
	<tr id="r_KHSID">
		...
		<td data-name="KHSID"<?php echo $khs->KHSID->CellAttributes() ?>>
<span id="el_khs_KHSID">
<span<?php echo $khs->KHSID->ViewAttributes() ?>>
<?php echo $khs->KHSID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $khs->ProdiID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $khs->TahunID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $khs->Sesi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $khs->Tingkat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $khs->Kelas->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $khs->StudentID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $khs->StatusStudentID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($khs->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		...
		<td data-name="Keterangan"<?php echo $khs->Keterangan->CellAttributes() ?>>
<span id="el_khs_Keterangan">
<span<?php echo $khs->Keterangan->ViewAttributes() ?>>
<?php echo $khs->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($khs->Creator->Visible) { // Creator ?>
	<tr id="r_Creator">
		<td><span id="elh_khs_Creator"><?php echo $khs->Creator->FldCaption() ?></span></td>
		<td data-name="Creator"<?php echo $khs->Creator->CellAttributes() ?>>
<span id="el_khs_Creator">
<span<?php echo $khs->Creator->ViewAttributes() ?>>
<?php echo $khs->Creator->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($khs->CreateDate->Visible) { // CreateDate ?>
	<tr id="r_CreateDate">
		<td><span id="elh_khs_CreateDate"><?php echo $khs->CreateDate->FldCaption() ?></span></td>
		<td data-name="CreateDate"<?php echo $khs->CreateDate->CellAttributes() ?>>
<span id="el_khs_CreateDate">
<span<?php echo $khs->CreateDate->ViewAttributes() ?>>
<?php echo $khs->CreateDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($khs->Editor->Visible) { // Editor ?>
	<tr id="r_Editor">
		<td><span id="elh_khs_Editor"><?php echo $khs->Editor->FldCaption() ?></span></td>
		<td data-name="Editor"<?php echo $khs->Editor->CellAttributes() ?>>
<span id="el_khs_Editor">
<span<?php echo $khs->Editor->ViewAttributes() ?>>
<?php echo $khs->Editor->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($khs->EditDate->Visible) { // EditDate ?>
	<tr id="r_EditDate">
		<td><span id="elh_khs_EditDate"><?php echo $khs->EditDate->FldCaption() ?></span></td>
		<td data-name="EditDate"<?php echo $khs->EditDate->CellAttributes() ?>>
<span id="el_khs_EditDate">
<span<?php echo $khs->EditDate->ViewAttributes() ?>>
<?php echo $khs->EditDate->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $khs->NA->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
