...
$master_jamkul_edit = NULL; // Initialize page object first

class cmaster_jamkul_edit extends cmaster_jamkul {
	...
	// Page object name
	var $PageObjName = 'master_jamkul_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->HariID->CurrentValue == "") {
			$this->Page_Terminate("master_jamkullist.php"); // Invalid key, return to list
		}
		if ($this->JamID->CurrentValue == "") {
			$this->Page_Terminate("master_jamkullist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($master_jamkul_edit)) $master_jamkul_edit = new cmaster_jamkul_edit();

// Page init
$master_jamkul_edit->Page_Init();

// Page main
$master_jamkul_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_jamkul_edit->Page_Render();
?>
...
var CurrentForm = fmaster_jamkuledit = new ew_Form("fmaster_jamkuledit", "edit");

// Validate form
fmaster_jamkuledit.Validate = function() {
...
fmaster_jamkuledit.Form_CustomValidate = 
...
fmaster_jamkuledit.ValidateRequired = true;
<?php } else { ?>
fmaster_jamkuledit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_jamkuledit.Lists["x_HariID"] = {"LinkField":"x_HariID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_hari"};
fmaster_jamkuledit.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_jamkuledit.Lists["x_NA"].Options = <?php echo json_encode($master_jamkul->NA->Options()) ?>;
...
<?php if (!$master_jamkul_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_jamkul_edit->ShowPageHeader(); ?>
<?php
$master_jamkul_edit->ShowMessage();
?>
<form name="fmaster_jamkuledit" id="fmaster_jamkuledit" class="<?php echo $master_jamkul_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_jamkul_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_jamkul_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_jamkul_edit->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_jamkul_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_jamkuledit" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<input type="hidden" data-table="master_jamkul" data-field="x_HariID" name="x_HariID" id="x_HariID" value="<?php echo ew_HtmlEncode($master_jamkul->HariID->CurrentValue) ?>">
...
<input type="hidden" data-table="master_jamkul" data-field="x_JamID" name="x_JamID" id="x_JamID" value="<?php echo ew_HtmlEncode($master_jamkul->JamID->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_jamkul_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_jamkuledit.Init();
</script>
<?php
$master_jamkul_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_jamkul_edit->Page_Terminate();
?>
