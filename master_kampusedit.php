...
$master_kampus_edit = NULL; // Initialize page object first

class cmaster_kampus_edit extends cmaster_kampus {
	...
	// Page object name
	var $PageObjName = 'master_kampus_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->KampusID->CurrentValue == "") {
			$this->Page_Terminate("master_kampuslist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($master_kampus_edit)) $master_kampus_edit = new cmaster_kampus_edit();

// Page init
$master_kampus_edit->Page_Init();

// Page main
$master_kampus_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_kampus_edit->Page_Render();
?>
...
var CurrentForm = fmaster_kampusedit = new ew_Form("fmaster_kampusedit", "edit");

// Validate form
fmaster_kampusedit.Validate = function() {
...
fmaster_kampusedit.Form_CustomValidate = 
...
fmaster_kampusedit.ValidateRequired = true;
<?php } else { ?>
fmaster_kampusedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_kampusedit.Lists["x_ProvinsiID"] = {"LinkField":"x_ProvinsiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Provinsi","","",""],"ParentFields":[],"ChildFields":["x_KabupatenKotaID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_provinsi"};
fmaster_kampusedit.Lists["x_KabupatenKotaID"] = {"LinkField":"x_KabupatenKotaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_KabupatenKota","","",""],"ParentFields":["x_ProvinsiID"],"ChildFields":["x_KecamatanID"],"FilterFields":["x_ProvinsiID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kabupatenkota"};
fmaster_kampusedit.Lists["x_KecamatanID"] = {"LinkField":"x_KecamatanID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Kecamatan","","",""],"ParentFields":["x_KabupatenKotaID"],"ChildFields":["x_DesaID"],"FilterFields":["x_KabupatenKotaID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kecamatan"};
fmaster_kampusedit.Lists["x_DesaID"] = {"LinkField":"x_DesaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Desa","","",""],"ParentFields":["x_KecamatanID"],"ChildFields":[],"FilterFields":["x_KecamatanID"],"Options":[],"Template":"","LinkTable":"master_wilayah_desa"};
fmaster_kampusedit.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_kampusedit.Lists["x_NA"].Options = <?php echo json_encode($master_kampus->NA->Options()) ?>;
...
<?php if (!$master_kampus_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_kampus_edit->ShowPageHeader(); ?>
<?php
$master_kampus_edit->ShowMessage();
?>
<form name="fmaster_kampusedit" id="fmaster_kampusedit" class="<?php echo $master_kampus_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_kampus_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_kampus_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_kampus_edit->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_kampus_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_kampusedit" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<p class="form-control-static"><?php echo $master_kampus->KampusID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="master_kampus" data-field="x_KampusID" name="x_KampusID" id="x_KampusID" value="<?php echo ew_HtmlEncode($master_kampus->KampusID->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_kampus_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_kampusedit.Init();
</script>
<?php
$master_kampus_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_kampus_edit->Page_Terminate();
?>
