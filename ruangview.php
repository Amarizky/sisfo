...
class cruang_view extends cruang {
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["RuangID"] <> "") {
			$this->RecKey["RuangID"] = $_GET["RuangID"];
			$KeyUrl .= "&amp;RuangID=" . urlencode($this->RecKey["RuangID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["RuangID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["RuangID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["RuangID"] <> "") {
				...
				$this->RecKey["RuangID"] = $this->RuangID->QueryStringValue;
			} elseif (@$_POST["RuangID"] <> "") {
				$this->RuangID->setFormValue($_POST["RuangID"]);
				$this->RecKey["RuangID"] = $this->RuangID->FormValue;
			} else {
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_ruang\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_ruang',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fruangview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
var CurrentForm = fruangview = new ew_Form("fruangview", "view");
...
fruangview.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fruangview.Lists["x_NA"].Options = <?php echo json_encode($ruang->NA->Options()) ?>;
...
<?php echo $ruang->RuangID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $ruang->Nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $ruang->KampusID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $ruang->Lantai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $ruang->ProdiID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $ruang->Kapasitas->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $ruang->KapasitasUjian->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($ruang->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		...
		<td data-name="Keterangan"<?php echo $ruang->Keterangan->CellAttributes() ?>>
<span id="el_ruang_Keterangan">
<span<?php echo $ruang->Keterangan->ViewAttributes() ?>>
<?php echo $ruang->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $ruang->NA->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
