...
$master_kelamin_search = NULL; // Initialize page object first

class cmaster_kelamin_search extends cmaster_kelamin {
	...
	// Page object name
	var $PageObjName = 'master_kelamin_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "master_kelaminlist.php" . "?" . $sSrchStr;
...
// Create page object
if (!isset($master_kelamin_search)) $master_kelamin_search = new cmaster_kelamin_search();

// Page init
$master_kelamin_search->Page_Init();

// Page main
$master_kelamin_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_kelamin_search->Page_Render();
?>
...
<?php if ($master_kelamin_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fmaster_kelaminsearch = new ew_Form("fmaster_kelaminsearch", "search");
<?php } else { ?>
var CurrentForm = fmaster_kelaminsearch = new ew_Form("fmaster_kelaminsearch", "search");
<?php } ?>

// Form_CustomValidate event
fmaster_kelaminsearch.Form_CustomValidate = 
...
fmaster_kelaminsearch.ValidateRequired = true;
<?php } else { ?>
fmaster_kelaminsearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_kelaminsearch.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_kelaminsearch.Lists["x_NA"].Options = <?php echo json_encode($master_kelamin->NA->Options()) ?>;

// Form object for search
// Validate function for search

fmaster_kelaminsearch.Validate = function(fobj) {
...
<?php } ?>
<?php $master_kelamin_search->ShowPageHeader(); ?>
<?php
$master_kelamin_search->ShowMessage();
?>
<form name="fmaster_kelaminsearch" id="fmaster_kelaminsearch" class="<?php echo $master_kelamin_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_kelamin_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_kelamin_search->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_kelamin_search->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_kelamin_search->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_kelaminsearch" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
<?php if ($master_kelamin->Kelamin->Visible) { // Kelamin ?>
<?php if (ew_IsMobile() || $master_kelamin_search->IsModal) { ?>
	<div id="r_Kelamin" class="form-group">
		<label for="x_Kelamin" class="<?php echo $master_kelamin_search->SearchLabelClass ?>"><span id="elh_master_kelamin_Kelamin"><?php echo $master_kelamin->Kelamin->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Kelamin" id="z_Kelamin" value="LIKE"></p>
		</label>
		<div class="<?php echo $master_kelamin_search->SearchRightColumnClass ?>"><div<?php echo $master_kelamin->Kelamin->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Kelamin">
		<td><span id="elh_master_kelamin_Kelamin"><?php echo $master_kelamin->Kelamin->FldCaption() ?></span></td>
		<td><span class="ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_Kelamin" id="z_Kelamin" value="LIKE"></span></td>
...
<?php if (ew_IsMobile() || $master_kelamin_search->IsModal) { ?>
	<div id="r_Nama" class="form-group">
		<label for="x_Nama" class="<?php echo $master_kelamin_search->SearchLabelClass ?>"><span id="elh_master_kelamin_Nama"><?php echo $master_kelamin->Nama->FldCaption() ?></span>	
		...
		<div class="<?php echo $master_kelamin_search->SearchRightColumnClass ?>"><div<?php echo $master_kelamin->Nama->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $master_kelamin_search->IsModal) { ?>
	<div id="r_NA" class="form-group">
		<label class="<?php echo $master_kelamin_search->SearchLabelClass ?>"><span id="elh_master_kelamin_NA"><?php echo $master_kelamin->NA->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_NA" id="z_NA" value="="></p>
		</label>
		<div class="<?php echo $master_kelamin_search->SearchRightColumnClass ?>"><div<?php echo $master_kelamin->NA->CellAttributes() ?>>
...
<script type="text/javascript">
fmaster_kelaminsearch.Init();
</script>
<?php
$master_kelamin_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_kelamin_search->Page_Terminate();
?>
