...
//
// Table class for master_prodi
//
class cmaster_prodi extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'master_prodi';
		$this->TableName = 'master_prodi';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`master_prodi`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ProdiID
		$this->ProdiID = new cField('master_prodi', 'master_prodi', 'x_ProdiID', 'ProdiID', '`ProdiID`', '`ProdiID`', 200, -1, FALSE, '`ProdiID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ProdiID->Sortable = TRUE; // Allow sort
		$this->fields['ProdiID'] = &$this->ProdiID;

		// Nama
		$this->Nama = new cField('master_prodi', 'master_prodi', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nama->Sortable = TRUE; // Allow sort
		$this->fields['Nama'] = &$this->Nama;

		// Pejabat
		$this->Pejabat = new cField('master_prodi', 'master_prodi', 'x_Pejabat', 'Pejabat', '`Pejabat`', '`Pejabat`', 200, -1, FALSE, '`Pejabat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->Pejabat->Sortable = TRUE; // Allow sort
		$this->Pejabat->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->Pejabat->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['Pejabat'] = &$this->Pejabat;

		// Keterangan
		$this->Keterangan = new cField('master_prodi', 'master_prodi', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 201, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Keterangan->Sortable = TRUE; // Allow sort
		$this->fields['Keterangan'] = &$this->Keterangan;

		// Akreditasi
		$this->Akreditasi = new cField('master_prodi', 'master_prodi', 'x_Akreditasi', 'Akreditasi', '`Akreditasi`', '`Akreditasi`', 200, -1, FALSE, '`Akreditasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Akreditasi->Sortable = TRUE; // Allow sort
		$this->fields['Akreditasi'] = &$this->Akreditasi;

		// NoSK
		$this->NoSK = new cField('master_prodi', 'master_prodi', 'x_NoSK', 'NoSK', '`NoSK`', '`NoSK`', 200, -1, FALSE, '`NoSK`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoSK->Sortable = TRUE; // Allow sort
		$this->fields['NoSK'] = &$this->NoSK;

		// TglSK
		$this->TglSK = new cField('master_prodi', 'master_prodi', 'x_TglSK', 'TglSK', '`TglSK`', ew_CastDateFieldForLike('`TglSK`', 0, "DB"), 133, 0, FALSE, '`TglSK`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TglSK->Sortable = TRUE; // Allow sort
		$this->TglSK->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['TglSK'] = &$this->TglSK;

		// Creator
		$this->Creator = new cField('master_prodi', 'master_prodi', 'x_Creator', 'Creator', '`Creator`', '`Creator`', 200, -1, FALSE, '`Creator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Creator->Sortable = TRUE; // Allow sort
		$this->fields['Creator'] = &$this->Creator;

		// CreateDate
		$this->CreateDate = new cField('master_prodi', 'master_prodi', 'x_CreateDate', 'CreateDate', '`CreateDate`', ew_CastDateFieldForLike('`CreateDate`', 0, "DB"), 133, 0, FALSE, '`CreateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Editor
		$this->Editor = new cField('master_prodi', 'master_prodi', 'x_Editor', 'Editor', '`Editor`', '`Editor`', 200, -1, FALSE, '`Editor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Editor->Sortable = TRUE; // Allow sort
		$this->fields['Editor'] = &$this->Editor;

		// EditDate
		$this->EditDate = new cField('master_prodi', 'master_prodi', 'x_EditDate', 'EditDate', '`EditDate`', ew_CastDateFieldForLike('`EditDate`', 0, "DB"), 133, 0, FALSE, '`EditDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NA
		$this->NA = new cField('master_prodi', 'master_prodi', 'x_NA', 'NA', '`NA`', '`NA`', 202, -1, FALSE, '`NA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`master_prodi`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("master_prodiview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("master_prodiview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "master_prodiadd.php?" . $this->UrlParm($parm);
		else
			$url = "master_prodiadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("master_prodiedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("master_prodiadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("master_prodidelete.php", $this->UrlParm());
	}
	...
	function GetRecordKeys() {
		...
		if (isset($_POST["key_m"])) {
			...
			if ($isPost && isset($_POST["ProdiID"]))
				$arKeys[] = ew_StripSlashes($_POST["ProdiID"]);
			elseif (isset($_GET["ProdiID"]))
				$arKeys[] = ew_StripSlashes($_GET["ProdiID"]);
			else
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->TglSK->EditValue = ew_FormatDateTime($this->TglSK->CurrentValue, 8);
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->Pejabat->Exportable) $Doc->ExportCaption($this->Pejabat);
					if ($this->Keterangan->Exportable) $Doc->ExportCaption($this->Keterangan);
					if ($this->Akreditasi->Exportable) $Doc->ExportCaption($this->Akreditasi);
					if ($this->NoSK->Exportable) $Doc->ExportCaption($this->NoSK);
					if ($this->TglSK->Exportable) $Doc->ExportCaption($this->TglSK);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->Pejabat->Exportable) $Doc->ExportField($this->Pejabat);
						if ($this->Keterangan->Exportable) $Doc->ExportField($this->Keterangan);
						if ($this->Akreditasi->Exportable) $Doc->ExportField($this->Akreditasi);
						if ($this->NoSK->Exportable) $Doc->ExportField($this->NoSK);
						if ($this->TglSK->Exportable) $Doc->ExportField($this->TglSK);
