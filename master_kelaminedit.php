...
$master_kelamin_edit = NULL; // Initialize page object first

class cmaster_kelamin_edit extends cmaster_kelamin {
	...
	// Page object name
	var $PageObjName = 'master_kelamin_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->Kelamin->CurrentValue == "") {
			$this->Page_Terminate("master_kelaminlist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($master_kelamin_edit)) $master_kelamin_edit = new cmaster_kelamin_edit();

// Page init
$master_kelamin_edit->Page_Init();

// Page main
$master_kelamin_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_kelamin_edit->Page_Render();
?>
...
var CurrentForm = fmaster_kelaminedit = new ew_Form("fmaster_kelaminedit", "edit");

// Validate form
fmaster_kelaminedit.Validate = function() {
...
fmaster_kelaminedit.Form_CustomValidate = 
...
fmaster_kelaminedit.ValidateRequired = true;
<?php } else { ?>
fmaster_kelaminedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_kelaminedit.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_kelaminedit.Lists["x_NA"].Options = <?php echo json_encode($master_kelamin->NA->Options()) ?>;
...
<?php if (!$master_kelamin_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_kelamin_edit->ShowPageHeader(); ?>
<?php
$master_kelamin_edit->ShowMessage();
?>
<form name="fmaster_kelaminedit" id="fmaster_kelaminedit" class="<?php echo $master_kelamin_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_kelamin_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_kelamin_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_kelamin_edit->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_kelamin_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_kelaminedit" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<p class="form-control-static"><?php echo $master_kelamin->Kelamin->EditValue ?></p></span>
</span>
<input type="hidden" data-table="master_kelamin" data-field="x_Kelamin" name="x_Kelamin" id="x_Kelamin" value="<?php echo ew_HtmlEncode($master_kelamin->Kelamin->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_kelamin_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_kelaminedit.Init();
</script>
<?php
$master_kelamin_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_kelamin_edit->Page_Terminate();
?>
