...
class cstaff extends cTable {
	...
	function __construct() {
		...
		// StaffID
		$this->StaffID = new cField('staff', 'staff', 'x_StaffID', 'StaffID', '`StaffID`', '`StaffID`', 200, -1, FALSE, '`StaffID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->StaffID->Sortable = TRUE; // Allow sort
		$this->fields['StaffID'] = &$this->StaffID;

		// LevelID
		$this->LevelID = new cField('staff', 'staff', 'x_LevelID', 'LevelID', '`LevelID`', '`LevelID`', 200, -1, FALSE, '`LevelID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Password
		$this->Password = new cField('staff', 'staff', 'x_Password', 'Password', '`Password`', '`Password`', 200, -1, FALSE, '`Password`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'PASSWORD');
		$this->Password->Sortable = FALSE; // Allow sort
		$this->fields['Password'] = &$this->Password;

		// NIPPNS
		$this->NIPPNS = new cField('staff', 'staff', 'x_NIPPNS', 'NIPPNS', '`NIPPNS`', '`NIPPNS`', 200, -1, FALSE, '`NIPPNS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NIPPNS->Sortable = TRUE; // Allow sort
		$this->fields['NIPPNS'] = &$this->NIPPNS;

		// Nama
		$this->Nama = new cField('staff', 'staff', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nama->Sortable = TRUE; // Allow sort
		$this->fields['Nama'] = &$this->Nama;

		// Gelar
		$this->Gelar = new cField('staff', 'staff', 'x_Gelar', 'Gelar', '`Gelar`', '`Gelar`', 200, -1, FALSE, '`Gelar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Gelar->Sortable = TRUE; // Allow sort
		$this->fields['Gelar'] = &$this->Gelar;

		// KTP
		$this->KTP = new cField('staff', 'staff', 'x_KTP', 'KTP', '`KTP`', '`KTP`', 200, -1, FALSE, '`KTP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->KTP->Sortable = TRUE; // Allow sort
		$this->fields['KTP'] = &$this->KTP;

		// TempatLahir
		$this->TempatLahir = new cField('staff', 'staff', 'x_TempatLahir', 'TempatLahir', '`TempatLahir`', '`TempatLahir`', 200, -1, FALSE, '`TempatLahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TempatLahir->Sortable = TRUE; // Allow sort
		$this->fields['TempatLahir'] = &$this->TempatLahir;

		// TanggalLahir
		$this->TanggalLahir = new cField('staff', 'staff', 'x_TanggalLahir', 'TanggalLahir', '`TanggalLahir`', ew_CastDateFieldForLike('`TanggalLahir`', 0, "DB"), 133, 0, FALSE, '`TanggalLahir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// KelaminID
		$this->KelaminID = new cField('staff', 'staff', 'x_KelaminID', 'KelaminID', '`KelaminID`', '`KelaminID`', 202, -1, FALSE, '`KelaminID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->KelaminID->Sortable = TRUE; // Allow sort
		$this->fields['KelaminID'] = &$this->KelaminID;

		// AgamaID
		$this->AgamaID = new cField('staff', 'staff', 'x_AgamaID', 'AgamaID', '`AgamaID`', '`AgamaID`', 3, -1, FALSE, '`AgamaID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Telephone
		$this->Telephone = new cField('staff', 'staff', 'x_Telephone', 'Telephone', '`Telephone`', '`Telephone`', 200, -1, FALSE, '`Telephone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Telephone->Sortable = TRUE; // Allow sort
		$this->fields['Telephone'] = &$this->Telephone;

		// Handphone
		$this->Handphone = new cField('staff', 'staff', 'x_Handphone', 'Handphone', '`Handphone`', '`Handphone`', 200, -1, FALSE, '`Handphone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Alamat
		$this->Alamat = new cField('staff', 'staff', 'x_Alamat', 'Alamat', '`Alamat`', '`Alamat`', 201, -1, FALSE, '`Alamat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Alamat->Sortable = TRUE; // Allow sort
		$this->fields['Alamat'] = &$this->Alamat;

		// KodePos
		$this->KodePos = new cField('staff', 'staff', 'x_KodePos', 'KodePos', '`KodePos`', '`KodePos`', 200, -1, FALSE, '`KodePos`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->KodePos->Sortable = TRUE; // Allow sort
		$this->fields['KodePos'] = &$this->KodePos;

		// ProvinsiID
		$this->ProvinsiID = new cField('staff', 'staff', 'x_ProvinsiID', 'ProvinsiID', '`ProvinsiID`', '`ProvinsiID`', 200, -1, FALSE, '`ProvinsiID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// KabupatenKotaID
		$this->KabupatenKotaID = new cField('staff', 'staff', 'x_KabupatenKotaID', 'KabupatenKotaID', '`KabupatenKotaID`', '`KabupatenKotaID`', 200, -1, FALSE, '`KabupatenKotaID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// KecamatanID
		$this->KecamatanID = new cField('staff', 'staff', 'x_KecamatanID', 'KecamatanID', '`KecamatanID`', '`KecamatanID`', 200, -1, FALSE, '`KecamatanID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DesaID
		$this->DesaID = new cField('staff', 'staff', 'x_DesaID', 'DesaID', '`DesaID`', '`DesaID`', 200, -1, FALSE, '`DesaID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// KampusID
		$this->KampusID = new cField('staff', 'staff', 'x_KampusID', 'KampusID', '`KampusID`', '`KampusID`', 200, -1, FALSE, '`KampusID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->KampusID->Sortable = TRUE; // Allow sort
		$this->fields['KampusID'] = &$this->KampusID;

		// BagianID
		$this->BagianID = new cField('staff', 'staff', 'x_BagianID', 'BagianID', '`BagianID`', '`BagianID`', 200, -1, FALSE, '`BagianID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->BagianID->Sortable = TRUE; // Allow sort
		$this->BagianID->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->BagianID->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['BagianID'] = &$this->BagianID;

		// GolonganID
		$this->GolonganID = new cField('staff', 'staff', 'x_GolonganID', 'GolonganID', '`GolonganID`', '`GolonganID`', 200, -1, FALSE, '`GolonganID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// IkatanID
		$this->IkatanID = new cField('staff', 'staff', 'x_IkatanID', 'IkatanID', '`IkatanID`', '`IkatanID`', 200, -1, FALSE, '`IkatanID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// StatusKerjaID
		$this->StatusKerjaID = new cField('staff', 'staff', 'x_StatusKerjaID', 'StatusKerjaID', '`StatusKerjaID`', '`StatusKerjaID`', 200, -1, FALSE, '`StatusKerjaID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// TglBekerja
		$this->TglBekerja = new cField('staff', 'staff', 'x_TglBekerja', 'TglBekerja', '`TglBekerja`', ew_CastDateFieldForLike('`TglBekerja`', 0, "DB"), 135, 0, FALSE, '`TglBekerja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// PendidikanTerakhir
		$this->PendidikanTerakhir = new cField('staff', 'staff', 'x_PendidikanTerakhir', 'PendidikanTerakhir', '`PendidikanTerakhir`', '`PendidikanTerakhir`', 200, -1, FALSE, '`PendidikanTerakhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->PendidikanTerakhir->Sortable = TRUE; // Allow sort
		$this->PendidikanTerakhir->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->PendidikanTerakhir->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['PendidikanTerakhir'] = &$this->PendidikanTerakhir;

		// Creator
		$this->Creator = new cField('staff', 'staff', 'x_Creator', 'Creator', '`Creator`', '`Creator`', 200, -1, FALSE, '`Creator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Creator->Sortable = TRUE; // Allow sort
		$this->fields['Creator'] = &$this->Creator;

		// CreateDate
		$this->CreateDate = new cField('staff', 'staff', 'x_CreateDate', 'CreateDate', '`CreateDate`', ew_CastDateFieldForLike('`CreateDate`', 0, "DB"), 135, 0, FALSE, '`CreateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Editor
		$this->Editor = new cField('staff', 'staff', 'x_Editor', 'Editor', '`Editor`', '`Editor`', 200, -1, FALSE, '`Editor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Editor->Sortable = TRUE; // Allow sort
		$this->fields['Editor'] = &$this->Editor;

		// EditDate
		$this->EditDate = new cField('staff', 'staff', 'x_EditDate', 'EditDate', '`EditDate`', ew_CastDateFieldForLike('`EditDate`', 0, "DB"), 135, 0, FALSE, '`EditDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NA
		$this->NA = new cField('staff', 'staff', 'x_NA', 'NA', '`NA`', '`NA`', 202, -1, FALSE, '`NA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function KeyToJson() {
		$json = "";
		$json .= "StaffID:" . ew_VarToJson($this->StaffID->CurrentValue, "string", "'");
		return "{" . $json . "}";
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->KampusID->EditValue = $this->KampusID->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->BagianID->Exportable) $Doc->ExportCaption($this->BagianID);
					...
					if ($this->PendidikanTerakhir->Exportable) $Doc->ExportCaption($this->PendidikanTerakhir);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->BagianID->Exportable) $Doc->ExportField($this->BagianID);
						...
						if ($this->PendidikanTerakhir->Exportable) $Doc->ExportField($this->PendidikanTerakhir);
