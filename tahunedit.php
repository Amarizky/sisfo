...
$tahun_edit = NULL; // Initialize page object first

class ctahun_edit extends ctahun {
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->TahunID->CurrentValue == "") {
			$this->Page_Terminate("tahunlist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($tahun_edit)) $tahun_edit = new ctahun_edit();

// Page init
$tahun_edit->Page_Init();

// Page main
$tahun_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tahun_edit->Page_Render();
?>
...
var CurrentForm = ftahunedit = new ew_Form("ftahunedit", "edit");

// Validate form
ftahunedit.Validate = function() {
...
ftahunedit.Form_CustomValidate = 
...
ftahunedit.ValidateRequired = true;
<?php } else { ?>
ftahunedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftahunedit.Lists["x_Sesi"] = {"LinkField":"x_Sesi","Ajax":true,"AutoFill":false,"DisplayFields":["x_NamaSesi","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_sesi"};
ftahunedit.Lists["x_ProdiID"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":true,"DisplayFields":["x_ProdiID","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
ftahunedit.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ftahunedit.Lists["x_NA"].Options = <?php echo json_encode($tahun->NA->Options()) ?>;
...
<?php } ?>
<?php $tahun_edit->ShowPageHeader(); ?>
<?php
$tahun_edit->ShowMessage();
?>
<form name="ftahunedit" id="ftahunedit" class="<?php echo $tahun_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($tahun_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $tahun_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$tahun_edit->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $tahun_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_tahunedit" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<p class="form-control-static"><?php echo $tahun->TahunID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tahun" data-field="x_TahunID" name="x_TahunID" id="x_TahunID" value="<?php echo ew_HtmlEncode($tahun->TahunID->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $tahun->Sesi->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tahun" data-field="x_Sesi" name="x_Sesi" id="x_Sesi" value="<?php echo ew_HtmlEncode($tahun->Sesi->CurrentValue) ?>">
...
<p class="form-control-static"><?php echo $tahun->ProdiID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="tahun" data-field="x_ProdiID" name="x_ProdiID" id="x_ProdiID" value="<?php echo ew_HtmlEncode($tahun->ProdiID->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $tahun_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
