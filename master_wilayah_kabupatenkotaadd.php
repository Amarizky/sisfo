...
$master_wilayah_kabupatenkota_add = NULL; // Initialize page object first

class cmaster_wilayah_kabupatenkota_add extends cmaster_wilayah_kabupatenkota {
	...
	// Page object name
	var $PageObjName = 'master_wilayah_kabupatenkota_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["KabupatenKotaID"] != "") {
				...
				$this->setKey("KabupatenKotaID", $this->KabupatenKotaID->CurrentValue); // Set up key
			} else {
				$this->setKey("KabupatenKotaID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "master_wilayah_kabupatenkotaview.php")
	...
	function LoadDefaultValues() {
		...
		$this->KabupatenKota->CurrentValue = NULL;
		$this->KabupatenKota->OldValue = $this->KabupatenKota->CurrentValue;
	}
	...
	function RenderRow() {
		...
		$this->KabupatenKota->ViewCustomAttributes = "";
			...
			$this->KabupatenKotaID->EditValue = ew_HtmlEncode($this->KabupatenKotaID->CurrentValue);
	...
	function AddRow($rsold = NULL) {
		...
		// KabupatenKota
		$this->KabupatenKota->SetDbValueDef($rsnew, $this->KabupatenKota->CurrentValue, "", FALSE);
		...
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['KabupatenKotaID']) == "") {
...
// Create page object
if (!isset($master_wilayah_kabupatenkota_add)) $master_wilayah_kabupatenkota_add = new cmaster_wilayah_kabupatenkota_add();

// Page init
$master_wilayah_kabupatenkota_add->Page_Init();

// Page main
$master_wilayah_kabupatenkota_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_wilayah_kabupatenkota_add->Page_Render();
?>
...
var CurrentForm = fmaster_wilayah_kabupatenkotaadd = new ew_Form("fmaster_wilayah_kabupatenkotaadd", "add");

// Validate form
fmaster_wilayah_kabupatenkotaadd.Validate = function() {
...
fmaster_wilayah_kabupatenkotaadd.Form_CustomValidate = 
...
fmaster_wilayah_kabupatenkotaadd.ValidateRequired = true;
<?php } else { ?>
fmaster_wilayah_kabupatenkotaadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_wilayah_kabupatenkotaadd.Lists["x_ProvinsiID"] = {"LinkField":"x_ProvinsiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Provinsi","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_provinsi"};
...
<?php if (!$master_wilayah_kabupatenkota_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_wilayah_kabupatenkota_add->ShowPageHeader(); ?>
<?php
$master_wilayah_kabupatenkota_add->ShowMessage();
?>
<form name="fmaster_wilayah_kabupatenkotaadd" id="fmaster_wilayah_kabupatenkotaadd" class="<?php echo $master_wilayah_kabupatenkota_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_wilayah_kabupatenkota_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_wilayah_kabupatenkota_add->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_wilayah_kabupatenkota_add->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_wilayah_kabupatenkota_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_wilayah_kabupatenkotaadd" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_wilayah_kabupatenkota_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_wilayah_kabupatenkotaadd.Init();
</script>
<?php
$master_wilayah_kabupatenkota_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_wilayah_kabupatenkota_add->Page_Terminate();
?>
