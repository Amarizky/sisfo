...
class cteacher_add extends cteacher {
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["TeacherID"] != "") {
				...
				$this->setKey("TeacherID", $this->TeacherID->CurrentValue); // Set up key
			} else {
				$this->setKey("TeacherID", ""); // Clear key
	...
	function LoadDefaultValues() {
		...
		$this->InstitusiInduk->OldValue = $this->InstitusiInduk->CurrentValue;
		...
		$this->Keilmuan->OldValue = $this->Keilmuan->CurrentValue;
		$this->LulusanPT->CurrentValue = NULL;
		$this->LulusanPT->OldValue = $this->LulusanPT->CurrentValue;
		$this->NamaBank->CurrentValue = NULL;
		$this->NamaBank->OldValue = $this->NamaBank->CurrentValue;
		$this->NamaAkun->CurrentValue = NULL;
		$this->NamaAkun->OldValue = $this->NamaAkun->CurrentValue;
		$this->NomerAkun->CurrentValue = NULL;
		$this->NomerAkun->OldValue = $this->NomerAkun->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// InstitusiInduk
		$this->InstitusiInduk->SetDbValueDef($rsnew, $this->InstitusiInduk->CurrentValue, NULL, FALSE);
		...
		// Keilmuan
		$this->Keilmuan->SetDbValueDef($rsnew, $this->Keilmuan->CurrentValue, NULL, FALSE);

		// LulusanPT
		$this->LulusanPT->SetDbValueDef($rsnew, $this->LulusanPT->CurrentValue, NULL, FALSE);

		// NamaBank
		$this->NamaBank->SetDbValueDef($rsnew, $this->NamaBank->CurrentValue, NULL, FALSE);

		// NamaAkun
		$this->NamaAkun->SetDbValueDef($rsnew, $this->NamaAkun->CurrentValue, NULL, FALSE);

		// NomerAkun
		$this->NomerAkun->SetDbValueDef($rsnew, $this->NomerAkun->CurrentValue, NULL, FALSE);
...
fteacheradd.ValidateRequired = true;
<?php } else { ?>
fteacheradd.ValidateRequired = false; 
<?php } ?>

// Multi-Page
fteacheradd.MultiPage = new ew_MultiPage("fteacheradd");

// Dynamic selection lists
fteacheradd.Lists["x_TempatLahir"] = {"LinkField":"x_KabupatenKotaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_KabupatenKota","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_kabupatenkota"};
fteacheradd.Lists["x_AgamaID"] = {"LinkField":"x_AgamaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_agama"};
fteacheradd.Lists["x_KelaminID"] = {"LinkField":"x_Kelamin","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_kelamin"};
fteacheradd.Lists["x_ProvinsiID"] = {"LinkField":"x_ProvinsiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Provinsi","","",""],"ParentFields":[],"ChildFields":["x_KabupatenKotaID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_provinsi"};
fteacheradd.Lists["x_KabupatenKotaID"] = {"LinkField":"x_KabupatenKotaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_KabupatenKota","","",""],"ParentFields":["x_ProvinsiID"],"ChildFields":["x_KecamatanID"],"FilterFields":["x_ProvinsiID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kabupatenkota"};
fteacheradd.Lists["x_KecamatanID"] = {"LinkField":"x_KecamatanID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Kecamatan","","",""],"ParentFields":["x_KabupatenKotaID"],"ChildFields":["x_DesaID"],"FilterFields":["x_KabupatenKotaID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kecamatan"};
fteacheradd.Lists["x_DesaID"] = {"LinkField":"x_DesaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Desa","","",""],"ParentFields":["x_KecamatanID"],"ChildFields":[],"FilterFields":["x_KecamatanID"],"Options":[],"Template":"","LinkTable":"master_wilayah_desa"};
fteacheradd.Lists["x_InstitusiInduk"] = {"LinkField":"x_KampusID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_kampus"};
fteacheradd.Lists["x_IkatanID"] = {"LinkField":"x_IkatanID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_ikatan"};
fteacheradd.Lists["x_GolonganID"] = {"LinkField":"x_GolonganID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_golongan"};
fteacheradd.Lists["x_StatusKerjaID"] = {"LinkField":"x_StatusKerjaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_statuskerja"};
fteacheradd.Lists["x_Homebase"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
fteacheradd.Lists["x_ProdiID[]"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
fteacheradd.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fteacheradd.Lists["x_NA"].Options = <?php echo json_encode($teacher->NA->Options()) ?>;
...
<?php } ?>
<?php if (!ew_IsMobile() && !$teacher_add->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<div class="ewMultiPage">
<div class="tabbable" id="teacher_add">
	<ul class="nav<?php echo $teacher_add->MultiPages->NavStyle() ?>">
		<li<?php echo $teacher_add->MultiPages->TabStyle("1") ?>><a href="#tab_teacher1" data-toggle="tab"><?php echo $teacher->PageCaption(1) ?></a></li>
		<li<?php echo $teacher_add->MultiPages->TabStyle("2") ?>><a href="#tab_teacher2" data-toggle="tab"><?php echo $teacher->PageCaption(2) ?></a></li>
		<li<?php echo $teacher_add->MultiPages->TabStyle("3") ?>><a href="#tab_teacher3" data-toggle="tab"><?php echo $teacher->PageCaption(3) ?></a></li>
		<li<?php echo $teacher_add->MultiPages->TabStyle("4") ?>><a href="#tab_teacher4" data-toggle="tab"><?php echo $teacher->PageCaption(4) ?></a></li>
		<li<?php echo $teacher_add->MultiPages->TabStyle("5") ?>><a href="#tab_teacher5" data-toggle="tab"><?php echo $teacher->PageCaption(5) ?></a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane<?php echo $teacher_add->MultiPages->PageStyle("1") ?>" id="tab_teacher1">
<?php if (ew_IsMobile() || $teacher_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_teacheradd1" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<input type="password" data-field="x_Password" name="x_Password" id="x_Password" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($teacher->Password->getPlaceHolder()) ?>"<?php echo $teacher->Password->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $teacher_add->MultiPages->PageStyle("2") ?>" id="tab_teacher2">
<?php if (ew_IsMobile() || $teacher_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_teacheradd2" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<script type="text/javascript">
fteacheradd.CreateAutoSuggest({"id":"x_TempatLahir","forceSelect":false});
</script>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("fteacheradd", "x_TanggalLahir", 0);
</script>
<?php } ?>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $teacher_add->MultiPages->PageStyle("3") ?>" id="tab_teacher3">
<?php if (ew_IsMobile() || $teacher_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_teacheradd3" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("fteacheradd", "x_TglBekerja", 0);
</script>
<?php } ?>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $teacher_add->MultiPages->PageStyle("4") ?>" id="tab_teacher4">
<?php if (ew_IsMobile() || $teacher_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_teacheradd4" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $teacher_add->MultiPages->PageStyle("5") ?>" id="tab_teacher5">
<?php if (ew_IsMobile() || $teacher_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_teacheradd5" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
