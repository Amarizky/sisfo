...
$master_wilayah_benua_add = NULL; // Initialize page object first

class cmaster_wilayah_benua_add extends cmaster_wilayah_benua {
	...
	// Page object name
	var $PageObjName = 'master_wilayah_benua_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["BenuaID"] != "") {
				...
				$this->setKey("BenuaID", $this->BenuaID->CurrentValue); // Set up key
			} else {
				$this->setKey("BenuaID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "master_wilayah_benuaview.php")
	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['BenuaID']) == "") {
...
// Create page object
if (!isset($master_wilayah_benua_add)) $master_wilayah_benua_add = new cmaster_wilayah_benua_add();

// Page init
$master_wilayah_benua_add->Page_Init();

// Page main
$master_wilayah_benua_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_wilayah_benua_add->Page_Render();
?>
...
var CurrentForm = fmaster_wilayah_benuaadd = new ew_Form("fmaster_wilayah_benuaadd", "add");

// Validate form
fmaster_wilayah_benuaadd.Validate = function() {
...
fmaster_wilayah_benuaadd.Form_CustomValidate = 
...
fmaster_wilayah_benuaadd.ValidateRequired = true;
<?php } else { ?>
fmaster_wilayah_benuaadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_wilayah_benuaadd.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_wilayah_benuaadd.Lists["x_NA"].Options = <?php echo json_encode($master_wilayah_benua->NA->Options()) ?>;
...
<?php if (!$master_wilayah_benua_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_wilayah_benua_add->ShowPageHeader(); ?>
<?php
$master_wilayah_benua_add->ShowMessage();
?>
<form name="fmaster_wilayah_benuaadd" id="fmaster_wilayah_benuaadd" class="<?php echo $master_wilayah_benua_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_wilayah_benua_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_wilayah_benua_add->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_wilayah_benua_add->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_wilayah_benua_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_wilayah_benuaadd" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_wilayah_benua_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_wilayah_benuaadd.Init();
</script>
<?php
$master_wilayah_benua_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_wilayah_benua_add->Page_Terminate();
?>
