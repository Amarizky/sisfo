...
class cmk extends cTable {
	...
	function __construct() {
		...
		// MKID
		$this->MKID = new cField('mk', 'mk', 'x_MKID', 'MKID', '`MKID`', '`MKID`', 20, -1, FALSE, '`MKID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->MKID->Sortable = TRUE; // Allow sort
		$this->MKID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['MKID'] = &$this->MKID;

		// KampusID
		$this->KampusID = new cField('mk', 'mk', 'x_KampusID', 'KampusID', '`KampusID`', '`KampusID`', 200, -1, FALSE, '`KampusID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// ProdiID
		$this->ProdiID = new cField('mk', 'mk', 'x_ProdiID', 'ProdiID', '`ProdiID`', '`ProdiID`', 200, -1, FALSE, '`ProdiID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// KurikulumID
		$this->KurikulumID = new cField('mk', 'mk', 'x_KurikulumID', 'KurikulumID', '`KurikulumID`', '`KurikulumID`', 3, -1, FALSE, '`KurikulumID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// MKKode
		$this->MKKode = new cField('mk', 'mk', 'x_MKKode', 'MKKode', '`MKKode`', '`MKKode`', 200, -1, FALSE, '`MKKode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MKKode->Sortable = TRUE; // Allow sort
		$this->fields['MKKode'] = &$this->MKKode;

		// Nama
		$this->Nama = new cField('mk', 'mk', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nama->Sortable = TRUE; // Allow sort
		$this->fields['Nama'] = &$this->Nama;

		// Singkatan
		$this->Singkatan = new cField('mk', 'mk', 'x_Singkatan', 'Singkatan', '`Singkatan`', '`Singkatan`', 200, -1, FALSE, '`Singkatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Singkatan->Sortable = TRUE; // Allow sort
		$this->fields['Singkatan'] = &$this->Singkatan;

		// Tingkat
		$this->Tingkat = new cField('mk', 'mk', 'x_Tingkat', 'Tingkat', '`Tingkat`', '`Tingkat`', 200, -1, FALSE, '`Tingkat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->Tingkat->Sortable = TRUE; // Allow sort
		$this->fields['Tingkat'] = &$this->Tingkat;

		// Sesi
		$this->Sesi = new cField('mk', 'mk', 'x_Sesi', 'Sesi', '`Sesi`', '`Sesi`', 3, -1, FALSE, '`Sesi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Wajib
		$this->Wajib = new cField('mk', 'mk', 'x_Wajib', 'Wajib', '`Wajib`', '`Wajib`', 202, -1, FALSE, '`Wajib`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// Deskripsi
		$this->Deskripsi = new cField('mk', 'mk', 'x_Deskripsi', 'Deskripsi', '`Deskripsi`', '`Deskripsi`', 201, -1, FALSE, '`Deskripsi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Deskripsi->Sortable = TRUE; // Allow sort
		$this->fields['Deskripsi'] = &$this->Deskripsi;

		// Creator
		$this->Creator = new cField('mk', 'mk', 'x_Creator', 'Creator', '`Creator`', '`Creator`', 200, -1, FALSE, '`Creator`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Creator->Sortable = TRUE; // Allow sort
		$this->fields['Creator'] = &$this->Creator;

		// CreateDate
		$this->CreateDate = new cField('mk', 'mk', 'x_CreateDate', 'CreateDate', '`CreateDate`', ew_CastDateFieldForLike('`CreateDate`', 0, "DB"), 135, 0, FALSE, '`CreateDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Editor
		$this->Editor = new cField('mk', 'mk', 'x_Editor', 'Editor', '`Editor`', ew_CastDateFieldForLike('`Editor`', 0, "DB"), 135, 0, FALSE, '`Editor`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// EditDate
		$this->EditDate = new cField('mk', 'mk', 'x_EditDate', 'EditDate', '`EditDate`', '`EditDate`', 200, -1, FALSE, '`EditDate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->EditDate->Sortable = TRUE; // Allow sort
		$this->fields['EditDate'] = &$this->EditDate;

		// NA
		$this->NA = new cField('mk', 'mk', 'x_NA', 'NA', '`NA`', '`NA`', 202, -1, FALSE, '`NA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`mk`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("mkview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("mkview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "mkadd.php?" . $this->UrlParm($parm);
		else
			$url = "mkadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("mkedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("mkadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("mkdelete.php", $this->UrlParm());
	}
