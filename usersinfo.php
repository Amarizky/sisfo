...
class cusers extends cTable {
	...
	function __construct() {
		...
		// Nama
		$this->Nama = new cField('users', 'users', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Nama->Sortable = TRUE; // Allow sort
		$this->fields['Nama'] = &$this->Nama;

		// LevelID
		$this->LevelID = new cField('users', 'users', 'x_LevelID', 'LevelID', '`LevelID`', '`LevelID`', 20, -1, FALSE, '`LevelID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->LevelID->Sortable = TRUE; // Allow sort
		$this->LevelID->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->LevelID->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->LevelID->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
