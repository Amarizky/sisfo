	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("ruanglist.php"); // Return to list
			}
		}
	}
...
var CurrentForm = fruangdelete = new ew_Form("fruangdelete", "delete");
...
fruangdelete.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fruangdelete.Lists["x_NA"].Options = <?php echo json_encode($ruang->NA->Options()) ?>;
...
<?php if ($ruang->RuangID->Visible) { // RuangID ?>
		<th><span id="elh_ruang_RuangID" class="ruang_RuangID"><?php echo $ruang->RuangID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($ruang->Nama->Visible) { // Nama ?>
		<th><span id="elh_ruang_Nama" class="ruang_Nama"><?php echo $ruang->Nama->FldCaption() ?></span></th>
<?php } ?>
<?php if ($ruang->KampusID->Visible) { // KampusID ?>
		<th><span id="elh_ruang_KampusID" class="ruang_KampusID"><?php echo $ruang->KampusID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($ruang->Lantai->Visible) { // Lantai ?>
		<th><span id="elh_ruang_Lantai" class="ruang_Lantai"><?php echo $ruang->Lantai->FldCaption() ?></span></th>
<?php } ?>
<?php if ($ruang->ProdiID->Visible) { // ProdiID ?>
		<th><span id="elh_ruang_ProdiID" class="ruang_ProdiID"><?php echo $ruang->ProdiID->FldCaption() ?></span></th>
<?php } ?>
<?php if ($ruang->Kapasitas->Visible) { // Kapasitas ?>
		<th><span id="elh_ruang_Kapasitas" class="ruang_Kapasitas"><?php echo $ruang->Kapasitas->FldCaption() ?></span></th>
<?php } ?>
<?php if ($ruang->KapasitasUjian->Visible) { // KapasitasUjian ?>
		<th><span id="elh_ruang_KapasitasUjian" class="ruang_KapasitasUjian"><?php echo $ruang->KapasitasUjian->FldCaption() ?></span></th>
<?php } ?>
<?php if ($ruang->NA->Visible) { // NA ?>
		<th><span id="elh_ruang_NA" class="ruang_NA"><?php echo $ruang->NA->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $ruang_delete->RowCnt ?>_ruang_RuangID" class="ruang_RuangID">
...
<span id="el<?php echo $ruang_delete->RowCnt ?>_ruang_Nama" class="ruang_Nama">
...
<span id="el<?php echo $ruang_delete->RowCnt ?>_ruang_KampusID" class="ruang_KampusID">
...
<span id="el<?php echo $ruang_delete->RowCnt ?>_ruang_Lantai" class="ruang_Lantai">
...
<span id="el<?php echo $ruang_delete->RowCnt ?>_ruang_ProdiID" class="ruang_ProdiID">
...
<span id="el<?php echo $ruang_delete->RowCnt ?>_ruang_Kapasitas" class="ruang_Kapasitas">
...
<span id="el<?php echo $ruang_delete->RowCnt ?>_ruang_KapasitasUjian" class="ruang_KapasitasUjian">
...
<span id="el<?php echo $ruang_delete->RowCnt ?>_ruang_NA" class="ruang_NA">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ruang_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fruangdelete.Init();
