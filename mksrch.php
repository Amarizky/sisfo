...
$mk_search = NULL; // Initialize page object first

class cmk_search extends cmk {
	...
	function RenderRow() {
		...
		$this->NA->ViewCustomAttributes = "";
			...
			if (trim(strval($this->Tingkat->AdvancedSearch->SearchValue)) == "") {
				...
				$arwrk = explode(",", $this->Tingkat->AdvancedSearch->SearchValue);
				$sFilterWrk = "";
				foreach ($arwrk as $wrk) {
					if ($sFilterWrk <> "") $sFilterWrk .= " OR ";
					$sFilterWrk .= "`Tingkat`" . ew_SearchString("=", trim($wrk), EW_DATATYPE_STRING, "");
...
// Create page object
if (!isset($mk_search)) $mk_search = new cmk_search();
...
<?php if ($mk_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fmksearch = new ew_Form("fmksearch", "search");
<?php } else { ?>
var CurrentForm = fmksearch = new ew_Form("fmksearch", "search");
<?php } ?>

// Form_CustomValidate event
fmksearch.Form_CustomValidate = 
...
fmksearch.ValidateRequired = true;
<?php } else { ?>
fmksearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmksearch.Lists["x_KampusID"] = {"LinkField":"x_KampusID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_kampus"};
fmksearch.Lists["x_ProdiID"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_KurikulumID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
fmksearch.Lists["x_KurikulumID"] = {"LinkField":"x_KurikulumID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":["x_ProdiID"],"ChildFields":[],"FilterFields":["x_ProdiID"],"Options":[],"Template":"","LinkTable":"kurikulum"};
fmksearch.Lists["x_Tingkat[]"] = {"LinkField":"x_Tingkat","Ajax":true,"AutoFill":false,"DisplayFields":["x_Tingkat","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kelas"};
fmksearch.Lists["x_Sesi"] = {"LinkField":"x_Sesi","Ajax":true,"AutoFill":false,"DisplayFields":["x_NamaSesi","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_sesi"};
fmksearch.Lists["x_Wajib"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmksearch.Lists["x_Wajib"].Options = <?php echo json_encode($mk->Wajib->Options()) ?>;
fmksearch.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmksearch.Lists["x_NA"].Options = <?php echo json_encode($mk->NA->Options()) ?>;

// Form object for search
// Validate function for search

fmksearch.Validate = function(fobj) {
...
<?php } ?>
<?php $mk_search->ShowPageHeader(); ?>
<?php
$mk_search->ShowMessage();
?>
<form name="fmksearch" id="fmksearch" class="<?php echo $mk_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($mk_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $mk_search->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$mk_search->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_mksearch" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
<?php if ($mk->KampusID->Visible) { // KampusID ?>
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_KampusID" class="form-group">
		<label for="x_KampusID" class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_KampusID"><?php echo $mk->KampusID->FldCaption() ?></span>	
		...
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->KampusID->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_ProdiID" class="form-group">
		<label for="x_ProdiID" class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_ProdiID"><?php echo $mk->ProdiID->FldCaption() ?></span>	
		...
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->ProdiID->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_KurikulumID" class="form-group">
		<label for="x_KurikulumID" class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_KurikulumID"><?php echo $mk->KurikulumID->FldCaption() ?></span>	
		...
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->KurikulumID->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_MKKode" class="form-group">
		<label for="x_MKKode" class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_MKKode"><?php echo $mk->MKKode->FldCaption() ?></span>	
		...
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->MKKode->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_Nama" class="form-group">
		<label for="x_Nama" class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_Nama"><?php echo $mk->Nama->FldCaption() ?></span>	
		...
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->Nama->CellAttributes() ?>>
			<span id="el_mk_Nama">
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_Singkatan" class="form-group">
		<label for="x_Singkatan" class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_Singkatan"><?php echo $mk->Singkatan->FldCaption() ?></span>	
		...
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->Singkatan->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_Tingkat" class="form-group">
		<label class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_Tingkat"><?php echo $mk->Tingkat->FldCaption() ?></span>	
		...
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->Tingkat->CellAttributes() ?>>
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_Sesi" class="form-group">
		<label for="x_Sesi" class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_Sesi"><?php echo $mk->Sesi->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Sesi" id="z_Sesi" value="="></p>
		</label>
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->Sesi->CellAttributes() ?>>
			<span id="el_mk_Sesi">
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_Wajib" class="form-group">
		<label class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_Wajib"><?php echo $mk->Wajib->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Wajib" id="z_Wajib" value="="></p>
		</label>
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->Wajib->CellAttributes() ?>>
			<span id="el_mk_Wajib">
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_Deskripsi" class="form-group">
		<label for="x_Deskripsi" class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_Deskripsi"><?php echo $mk->Deskripsi->FldCaption() ?></span>	
		...
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->Deskripsi->CellAttributes() ?>>
			<span id="el_mk_Deskripsi">
<input type="text" data-table="mk" data-field="x_Deskripsi" name="x_Deskripsi" id="x_Deskripsi" size="35" placeholder="<?php echo ew_HtmlEncode($mk->Deskripsi->getPlaceHolder()) ?>" value="<?php echo $mk->Deskripsi->EditValue ?>"<?php echo $mk->Deskripsi->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } else { ?>
...
<?php if (ew_IsMobile() || $mk_search->IsModal) { ?>
	<div id="r_NA" class="form-group">
		<label class="<?php echo $mk_search->SearchLabelClass ?>"><span id="elh_mk_NA"><?php echo $mk->NA->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_NA" id="z_NA" value="="></p>
		</label>
		<div class="<?php echo $mk_search->SearchRightColumnClass ?>"><div<?php echo $mk->NA->CellAttributes() ?>>
			<span id="el_mk_NA">
