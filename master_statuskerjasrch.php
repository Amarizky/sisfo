...
$master_statuskerja_search = NULL; // Initialize page object first

class cmaster_statuskerja_search extends cmaster_statuskerja {
	...
	// Page object name
	var $PageObjName = 'master_statuskerja_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "master_statuskerjalist.php" . "?" . $sSrchStr;
	...
	function RenderRow() {
		...
		$this->NA->ViewCustomAttributes = "";
			...
			$this->StatusKerjaID->EditValue = ew_HtmlEncode($this->StatusKerjaID->AdvancedSearch->SearchValue);
			$this->StatusKerjaID->PlaceHolder = ew_RemoveHtml($this->StatusKerjaID->FldCaption());
...
// Create page object
if (!isset($master_statuskerja_search)) $master_statuskerja_search = new cmaster_statuskerja_search();

// Page init
$master_statuskerja_search->Page_Init();

// Page main
$master_statuskerja_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_statuskerja_search->Page_Render();
?>
...
<?php if ($master_statuskerja_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fmaster_statuskerjasearch = new ew_Form("fmaster_statuskerjasearch", "search");
<?php } else { ?>
var CurrentForm = fmaster_statuskerjasearch = new ew_Form("fmaster_statuskerjasearch", "search");
<?php } ?>

// Form_CustomValidate event
fmaster_statuskerjasearch.Form_CustomValidate = 
...
fmaster_statuskerjasearch.ValidateRequired = true;
<?php } else { ?>
fmaster_statuskerjasearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_statuskerjasearch.Lists["x_Def"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statuskerjasearch.Lists["x_Def"].Options = <?php echo json_encode($master_statuskerja->Def->Options()) ?>;
fmaster_statuskerjasearch.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statuskerjasearch.Lists["x_NA"].Options = <?php echo json_encode($master_statuskerja->NA->Options()) ?>;

// Form object for search
// Validate function for search

fmaster_statuskerjasearch.Validate = function(fobj) {
...
<?php } ?>
<?php $master_statuskerja_search->ShowPageHeader(); ?>
<?php
$master_statuskerja_search->ShowMessage();
?>
<form name="fmaster_statuskerjasearch" id="fmaster_statuskerjasearch" class="<?php echo $master_statuskerja_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_statuskerja_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_statuskerja_search->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_statuskerja_search->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_statuskerja_search->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_statuskerjasearch" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
<?php if ($master_statuskerja->StatusKerjaID->Visible) { // StatusKerjaID ?>
<?php if (ew_IsMobile() || $master_statuskerja_search->IsModal) { ?>
	<div id="r_StatusKerjaID" class="form-group">
		<label for="x_StatusKerjaID" class="<?php echo $master_statuskerja_search->SearchLabelClass ?>"><span id="elh_master_statuskerja_StatusKerjaID"><?php echo $master_statuskerja->StatusKerjaID->FldCaption() ?></span>	
		...
		<div class="<?php echo $master_statuskerja_search->SearchRightColumnClass ?>"><div<?php echo $master_statuskerja->StatusKerjaID->CellAttributes() ?>>
			<span id="el_master_statuskerja_StatusKerjaID">
<input type="text" data-table="master_statuskerja" data-field="x_StatusKerjaID" name="x_StatusKerjaID" id="x_StatusKerjaID" size="30" maxlength="5" placeholder="<?php echo ew_HtmlEncode($master_statuskerja->StatusKerjaID->getPlaceHolder()) ?>" value="<?php echo $master_statuskerja->StatusKerjaID->EditValue ?>"<?php echo $master_statuskerja->StatusKerjaID->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } else { ?>
	<tr id="r_StatusKerjaID">
		<td><span id="elh_master_statuskerja_StatusKerjaID"><?php echo $master_statuskerja->StatusKerjaID->FldCaption() ?></span></td>
...
<?php if (ew_IsMobile() || $master_statuskerja_search->IsModal) { ?>
	<div id="r_Nama" class="form-group">
		<label for="x_Nama" class="<?php echo $master_statuskerja_search->SearchLabelClass ?>"><span id="elh_master_statuskerja_Nama"><?php echo $master_statuskerja->Nama->FldCaption() ?></span>	
		...
		<div class="<?php echo $master_statuskerja_search->SearchRightColumnClass ?>"><div<?php echo $master_statuskerja->Nama->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Nama">
		<td><span id="elh_master_statuskerja_Nama"><?php echo $master_statuskerja->Nama->FldCaption() ?></span></td>
...
<?php if (ew_IsMobile() || $master_statuskerja_search->IsModal) { ?>
	<div id="r_Def" class="form-group">
		<label class="<?php echo $master_statuskerja_search->SearchLabelClass ?>"><span id="elh_master_statuskerja_Def"><?php echo $master_statuskerja->Def->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_Def" id="z_Def" value="="></p>
		</label>
		<div class="<?php echo $master_statuskerja_search->SearchRightColumnClass ?>"><div<?php echo $master_statuskerja->Def->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_Def">
		<td><span id="elh_master_statuskerja_Def"><?php echo $master_statuskerja->Def->FldCaption() ?></span></td>
...
<?php if (ew_IsMobile() || $master_statuskerja_search->IsModal) { ?>
	<div id="r_NA" class="form-group">
		<label class="<?php echo $master_statuskerja_search->SearchLabelClass ?>"><span id="elh_master_statuskerja_NA"><?php echo $master_statuskerja->NA->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_NA" id="z_NA" value="="></p>
		</label>
		<div class="<?php echo $master_statuskerja_search->SearchRightColumnClass ?>"><div<?php echo $master_statuskerja->NA->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_NA">
		<td><span id="elh_master_statuskerja_NA"><?php echo $master_statuskerja->NA->FldCaption() ?></span></td>
...
<script type="text/javascript">
fmaster_statuskerjasearch.Init();
</script>
<?php
$master_statuskerja_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_statuskerja_search->Page_Terminate();
?>
