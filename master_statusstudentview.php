...
$master_statusstudent_view = NULL; // Initialize page object first

class cmaster_statusstudent_view extends cmaster_statusstudent {
	...
	// Page object name
	var $PageObjName = 'master_statusstudent_view';
	...
	function __construct() {
		...
		if (@$_GET["StatusStudentID"] <> "") {
			$this->RecKey["StatusStudentID"] = $_GET["StatusStudentID"];
			$KeyUrl .= "&amp;StatusStudentID=" . urlencode($this->RecKey["StatusStudentID"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["StatusStudentID"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["StatusStudentID"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["StatusStudentID"] <> "") {
				...
				$this->RecKey["StatusStudentID"] = $this->StatusStudentID->QueryStringValue;
			} elseif (@$_POST["StatusStudentID"] <> "") {
				$this->StatusStudentID->setFormValue($_POST["StatusStudentID"]);
				$this->RecKey["StatusStudentID"] = $this->StatusStudentID->FormValue;
			} else {
				$sReturnUrl = "master_statusstudentlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "master_statusstudentlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "master_statusstudentlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($master_statusstudent_view)) $master_statusstudent_view = new cmaster_statusstudent_view();

// Page init
$master_statusstudent_view->Page_Init();

// Page main
$master_statusstudent_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_statusstudent_view->Page_Render();
?>
...
var CurrentForm = fmaster_statusstudentview = new ew_Form("fmaster_statusstudentview", "view");

// Form_CustomValidate event
fmaster_statusstudentview.Form_CustomValidate = 
...
fmaster_statusstudentview.ValidateRequired = true;
<?php } else { ?>
fmaster_statusstudentview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_statusstudentview.Lists["x_Keluar"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statusstudentview.Lists["x_Keluar"].Options = <?php echo json_encode($master_statusstudent->Keluar->Options()) ?>;
fmaster_statusstudentview.Lists["x_Def"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statusstudentview.Lists["x_Def"].Options = <?php echo json_encode($master_statusstudent->Def->Options()) ?>;
fmaster_statusstudentview.Lists["x_Lulus"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statusstudentview.Lists["x_Lulus"].Options = <?php echo json_encode($master_statusstudent->Lulus->Options()) ?>;
fmaster_statusstudentview.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statusstudentview.Lists["x_NA"].Options = <?php echo json_encode($master_statusstudent->NA->Options()) ?>;
...
<?php if ($master_statusstudent->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$master_statusstudent_view->IsModal) { ?>
<?php if ($master_statusstudent->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $master_statusstudent_view->ExportOptions->Render("body") ?>
<?php
	foreach ($master_statusstudent_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$master_statusstudent_view->IsModal) { ?>
<?php if ($master_statusstudent->Export == "") { ?>
...
<?php } ?>
<?php $master_statusstudent_view->ShowPageHeader(); ?>
<?php
$master_statusstudent_view->ShowMessage();
?>
<form name="fmaster_statusstudentview" id="fmaster_statusstudentview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_statusstudent_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_statusstudent_view->Token ?>">
<?php } ?>
...
<?php echo $master_statusstudent->StatusStudentID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_statusstudent->Nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_statusstudent->Nilai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_statusstudent->Keluar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_statusstudent->Def->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_statusstudent->Lulus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php echo $master_statusstudent->NA->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($master_statusstudent->Export == "") { ?>
<script type="text/javascript">
fmaster_statusstudentview.Init();
</script>
<?php } ?>
<?php
$master_statusstudent_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($master_statusstudent->Export == "") { ?>
...
<?php
$master_statusstudent_view->Page_Terminate();
?>
