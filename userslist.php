...
class cusers_list extends cusers {
	...
	function SetupSearchOptions() {
		...
		if (ew_IsMobile())
			...
			$item->Body = "<button type=\"button\" class=\"btn btn-default ewAdvancedSearch\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-table=\"users\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" onclick=\"ew_ModalDialogShow({lnk:this,url:'userssrch.php',caption:'" . $Language->Phrase("Search") . "'});\">" . $Language->Phrase("AdvancedSearchBtn") . "</button>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->Add("searchhighlight");
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewHighlight active\" title=\"" . $Language->Phrase("Highlight") . "\" data-caption=\"" . $Language->Phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fuserslistsrch\" data-name=\"" . $this->HighlightName() . "\">" . $Language->Phrase("HighlightBtn") . "</button>";
	...
	function RenderRow() {
		...
		$this->_Email->ViewCustomAttributes = "";
			...
			if ($this->Export == "")
				$this->Username->ViewValue = ew_Highlight($this->HighlightName(), $this->Username->ViewValue, $this->BasicSearch->getKeyword(), $this->BasicSearch->getType(), $this->Username->AdvancedSearch->getValue("x"), "");
...
fuserslist.Lists["x_LevelID"] = {"LinkField":"x_userlevelid","Ajax":true,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"userlevels"};
...
<?php if ($users->Nama->Visible) { // Nama ?>
	<?php if ($users->SortUrl($users->Nama) == "") { ?>
		<th data-name="Nama"><div id="elh_users_Nama" class="users_Nama"><div class="ewTableHeaderCaption"><?php echo $users->Nama->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Nama"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->Nama) ?>',1);"><div id="elh_users_Nama" class="users_Nama">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->Nama->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($users->Nama->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->Nama->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($users->LevelID->Visible) { // LevelID ?>
	<?php if ($users->SortUrl($users->LevelID) == "") { ?>
		<th data-name="LevelID"><div id="elh_users_LevelID" class="users_LevelID"><div class="ewTableHeaderCaption"><?php echo $users->LevelID->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="LevelID"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $users->SortUrl($users->LevelID) ?>',1);"><div id="elh_users_LevelID" class="users_LevelID">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $users->LevelID->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($users->LevelID->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($users->LevelID->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
?>
	<?php if ($users->Nama->Visible) { // Nama ?>
		<td data-name="Nama"<?php echo $users->Nama->CellAttributes() ?>>
<span id="el<?php echo $users_list->RowCnt ?>_users_Nama" class="users_Nama">
<span<?php echo $users->Nama->ViewAttributes() ?>>
<?php echo $users->Nama->ListViewValue() ?></span>
</span>
<a id="<?php echo $users_list->PageObjName . "_row_" . $users_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($users->LevelID->Visible) { // LevelID ?>
		<td data-name="LevelID"<?php echo $users->LevelID->CellAttributes() ?>>
<span id="el<?php echo $users_list->RowCnt ?>_users_LevelID" class="users_LevelID">
<span<?php echo $users->LevelID->ViewAttributes() ?>>
<?php echo $users->LevelID->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($users->Username->Visible) { // Username ?>
