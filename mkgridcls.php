...
$mk_grid = NULL; // Initialize page object first

class cmk_grid extends cmk {
	...
	// Page object name
	var $PageObjName = 'mk_grid';

	// Grid form hidden field names
	var $FormName = 'fmkgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["mk"];
