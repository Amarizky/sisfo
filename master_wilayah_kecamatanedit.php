...
$master_wilayah_kecamatan_edit = NULL; // Initialize page object first

class cmaster_wilayah_kecamatan_edit extends cmaster_wilayah_kecamatan {
	...
	// Page object name
	var $PageObjName = 'master_wilayah_kecamatan_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->KecamatanID->CurrentValue == "") {
			$this->Page_Terminate("master_wilayah_kecamatanlist.php"); // Invalid key, return to list
		}
	...
	function RenderRow() {
		...
		$this->Kecamatan->ViewCustomAttributes = "";
			...
			$this->KecamatanID->EditValue = $this->KecamatanID->CurrentValue;
			$this->KecamatanID->ViewCustomAttributes = "";
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->KabupatenKotaID->SetDbValueDef($rsnew, $this->KabupatenKotaID->CurrentValue, "", $this->KabupatenKotaID->ReadOnly);
...
// Create page object
if (!isset($master_wilayah_kecamatan_edit)) $master_wilayah_kecamatan_edit = new cmaster_wilayah_kecamatan_edit();

// Page init
$master_wilayah_kecamatan_edit->Page_Init();

// Page main
$master_wilayah_kecamatan_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_wilayah_kecamatan_edit->Page_Render();
?>
...
var CurrentForm = fmaster_wilayah_kecamatanedit = new ew_Form("fmaster_wilayah_kecamatanedit", "edit");

// Validate form
fmaster_wilayah_kecamatanedit.Validate = function() {
...
fmaster_wilayah_kecamatanedit.Form_CustomValidate = 
...
fmaster_wilayah_kecamatanedit.ValidateRequired = true;
<?php } else { ?>
fmaster_wilayah_kecamatanedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_wilayah_kecamatanedit.Lists["x_KabupatenKotaID"] = {"LinkField":"x_KabupatenKotaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_KabupatenKota","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_kabupatenkota"};
...
<?php if (!$master_wilayah_kecamatan_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_wilayah_kecamatan_edit->ShowPageHeader(); ?>
<?php
$master_wilayah_kecamatan_edit->ShowMessage();
?>
<form name="fmaster_wilayah_kecamatanedit" id="fmaster_wilayah_kecamatanedit" class="<?php echo $master_wilayah_kecamatan_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_wilayah_kecamatan_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_wilayah_kecamatan_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_wilayah_kecamatan_edit->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_wilayah_kecamatan_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_wilayah_kecamatanedit" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<p class="form-control-static"><?php echo $master_wilayah_kecamatan->KecamatanID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="master_wilayah_kecamatan" data-field="x_KecamatanID" name="x_KecamatanID" id="x_KecamatanID" value="<?php echo ew_HtmlEncode($master_wilayah_kecamatan->KecamatanID->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_wilayah_kecamatan_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_wilayah_kecamatanedit.Init();
</script>
<?php
$master_wilayah_kecamatan_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_wilayah_kecamatan_edit->Page_Terminate();
?>
