...
$mk_edit = NULL; // Initialize page object first

class cmk_edit extends cmk {
	...
	function Page_Main() {
		...
		if ($this->MKID->CurrentValue == "") {
			$this->Page_Terminate("mklist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("mklist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "mklist.php")
...
// Create page object
if (!isset($mk_edit)) $mk_edit = new cmk_edit();
...
var CurrentForm = fmkedit = new ew_Form("fmkedit", "edit");

// Validate form
fmkedit.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $mk->ProdiID->FldCaption(), $mk->ProdiID->ReqErrMsg)) ?>");
...
fmkedit.ValidateRequired = true;
<?php } else { ?>
fmkedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmkedit.Lists["x_KampusID"] = {"LinkField":"x_KampusID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_kampus"};
fmkedit.Lists["x_ProdiID"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":["x_KurikulumID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
fmkedit.Lists["x_KurikulumID"] = {"LinkField":"x_KurikulumID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":["x_ProdiID"],"ChildFields":[],"FilterFields":["x_ProdiID"],"Options":[],"Template":"","LinkTable":"kurikulum"};
fmkedit.Lists["x_Tingkat[]"] = {"LinkField":"x_Tingkat","Ajax":true,"AutoFill":false,"DisplayFields":["x_Tingkat","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"kelas"};
fmkedit.Lists["x_Sesi"] = {"LinkField":"x_Sesi","Ajax":true,"AutoFill":false,"DisplayFields":["x_NamaSesi","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_sesi"};
fmkedit.Lists["x_Wajib"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmkedit.Lists["x_Wajib"].Options = <?php echo json_encode($mk->Wajib->Options()) ?>;
fmkedit.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmkedit.Lists["x_NA"].Options = <?php echo json_encode($mk->NA->Options()) ?>;
...
<?php } ?>
<?php $mk_edit->ShowPageHeader(); ?>
<?php
$mk_edit->ShowMessage();
?>
<form name="fmkedit" id="fmkedit" class="<?php echo $mk_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($mk_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $mk_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if ($mk->getCurrentMasterTable() == "kurikulum") { ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$mk_edit->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_mkedit" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
<?php if ($mk->MKID->Visible) { // MKID ?>
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_MKID" class="form-group">
		<label id="elh_mk_MKID" class="col-sm-2 control-label ewLabel"><?php echo $mk->MKID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->MKID->CellAttributes() ?>>
<span id="el_mk_MKID">
<span<?php echo $mk->MKID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $mk->MKID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="mk" data-field="x_MKID" name="x_MKID" id="x_MKID" value="<?php echo ew_HtmlEncode($mk->MKID->CurrentValue) ?>">
<?php echo $mk->MKID->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_MKID">
		<td><span id="elh_mk_MKID"><?php echo $mk->MKID->FldCaption() ?></span></td>
		<td<?php echo $mk->MKID->CellAttributes() ?>>
<span id="el_mk_MKID">
<span<?php echo $mk->MKID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $mk->MKID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="mk" data-field="x_MKID" name="x_MKID" id="x_MKID" value="<?php echo ew_HtmlEncode($mk->MKID->CurrentValue) ?>">
<?php echo $mk->MKID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_KampusID" class="form-group">
		<label id="elh_mk_KampusID" for="x_KampusID" class="col-sm-2 control-label ewLabel"><?php echo $mk->KampusID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->KampusID->CellAttributes() ?>>
<?php if ($mk->KampusID->getSessionValue() <> "") { ?>
<span id="el_mk_KampusID">
<span<?php echo $mk->KampusID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $mk->KampusID->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_KampusID" name="x_KampusID" value="<?php echo ew_HtmlEncode($mk->KampusID->CurrentValue) ?>">
<?php } else { ?>
<span id="el_mk_KampusID">
<select data-table="mk" data-field="x_KampusID" data-value-separator="<?php echo $mk->KampusID->DisplayValueSeparatorAttribute() ?>" id="x_KampusID" name="x_KampusID"<?php echo $mk->KampusID->EditAttributes() ?>>
<?php echo $mk->KampusID->SelectOptionListHtml("x_KampusID") ?>
</select>
<input type="hidden" name="s_x_KampusID" id="s_x_KampusID" value="<?php echo $mk->KampusID->LookupFilterQuery() ?>">
</span>
<?php } ?>
<?php echo $mk->KampusID->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_KampusID">
		<td><span id="elh_mk_KampusID"><?php echo $mk->KampusID->FldCaption() ?></span></td>
		<td<?php echo $mk->KampusID->CellAttributes() ?>>
<?php if ($mk->KampusID->getSessionValue() <> "") { ?>
<span id="el_mk_KampusID">
<span<?php echo $mk->KampusID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $mk->KampusID->ViewValue ?></p></span>
...
<?php } ?>
<?php echo $mk->KampusID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_ProdiID" class="form-group">
		<label id="elh_mk_ProdiID" for="x_ProdiID" class="col-sm-2 control-label ewLabel"><?php echo $mk->ProdiID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $mk->ProdiID->CellAttributes() ?>>
<?php if ($mk->ProdiID->getSessionValue() <> "") { ?>
<span id="el_mk_ProdiID">
<span<?php echo $mk->ProdiID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $mk->ProdiID->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_ProdiID" name="x_ProdiID" value="<?php echo ew_HtmlEncode($mk->ProdiID->CurrentValue) ?>">
<?php } else { ?>
<span id="el_mk_ProdiID">
<?php $mk->ProdiID->EditAttrs["onchange"] = "ew_UpdateOpt.call(this); " . @$mk->ProdiID->EditAttrs["onchange"]; ?>
<select data-table="mk" data-field="x_ProdiID" data-value-separator="<?php echo $mk->ProdiID->DisplayValueSeparatorAttribute() ?>" id="x_ProdiID" name="x_ProdiID"<?php echo $mk->ProdiID->EditAttributes() ?>>
<?php echo $mk->ProdiID->SelectOptionListHtml("x_ProdiID") ?>
</select>
<input type="hidden" name="s_x_ProdiID" id="s_x_ProdiID" value="<?php echo $mk->ProdiID->LookupFilterQuery() ?>">
</span>
<?php } ?>
<?php echo $mk->ProdiID->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_ProdiID">
		<td><span id="elh_mk_ProdiID"><?php echo $mk->ProdiID->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $mk->ProdiID->CellAttributes() ?>>
<?php if ($mk->ProdiID->getSessionValue() <> "") { ?>
<span id="el_mk_ProdiID">
<span<?php echo $mk->ProdiID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $mk->ProdiID->ViewValue ?></p></span>
...
<?php } ?>
<?php echo $mk->ProdiID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_KurikulumID" class="form-group">
		<label id="elh_mk_KurikulumID" for="x_KurikulumID" class="col-sm-2 control-label ewLabel"><?php echo $mk->KurikulumID->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->KurikulumID->CellAttributes() ?>>
<?php if ($mk->KurikulumID->getSessionValue() <> "") { ?>
<span id="el_mk_KurikulumID">
<span<?php echo $mk->KurikulumID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $mk->KurikulumID->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_KurikulumID" name="x_KurikulumID" value="<?php echo ew_HtmlEncode($mk->KurikulumID->CurrentValue) ?>">
<?php } else { ?>
<span id="el_mk_KurikulumID">
<select data-table="mk" data-field="x_KurikulumID" data-value-separator="<?php echo $mk->KurikulumID->DisplayValueSeparatorAttribute() ?>" id="x_KurikulumID" name="x_KurikulumID"<?php echo $mk->KurikulumID->EditAttributes() ?>>
<?php echo $mk->KurikulumID->SelectOptionListHtml("x_KurikulumID") ?>
</select>
<input type="hidden" name="s_x_KurikulumID" id="s_x_KurikulumID" value="<?php echo $mk->KurikulumID->LookupFilterQuery() ?>">
</span>
<?php } ?>
<?php echo $mk->KurikulumID->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_KurikulumID">
		<td><span id="elh_mk_KurikulumID"><?php echo $mk->KurikulumID->FldCaption() ?></span></td>
		<td<?php echo $mk->KurikulumID->CellAttributes() ?>>
<?php if ($mk->KurikulumID->getSessionValue() <> "") { ?>
<span id="el_mk_KurikulumID">
<span<?php echo $mk->KurikulumID->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $mk->KurikulumID->ViewValue ?></p></span>
...
<?php } ?>
<?php echo $mk->KurikulumID->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_MKKode" class="form-group">
		<label id="elh_mk_MKKode" for="x_MKKode" class="col-sm-2 control-label ewLabel"><?php echo $mk->MKKode->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->MKKode->CellAttributes() ?>>
<span id="el_mk_MKKode">
<input type="text" data-table="mk" data-field="x_MKKode" name="x_MKKode" id="x_MKKode" size="7" maxlength="20" placeholder="<?php echo ew_HtmlEncode($mk->MKKode->getPlaceHolder()) ?>" value="<?php echo $mk->MKKode->EditValue ?>"<?php echo $mk->MKKode->EditAttributes() ?>>
</span>
<?php echo $mk->MKKode->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_MKKode">
		<td><span id="elh_mk_MKKode"><?php echo $mk->MKKode->FldCaption() ?></span></td>
		<td<?php echo $mk->MKKode->CellAttributes() ?>>
<span id="el_mk_MKKode">
<input type="text" data-table="mk" data-field="x_MKKode" name="x_MKKode" id="x_MKKode" size="7" maxlength="20" placeholder="<?php echo ew_HtmlEncode($mk->MKKode->getPlaceHolder()) ?>" value="<?php echo $mk->MKKode->EditValue ?>"<?php echo $mk->MKKode->EditAttributes() ?>>
</span>
<?php echo $mk->MKKode->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_Nama" class="form-group">
		<label id="elh_mk_Nama" for="x_Nama" class="col-sm-2 control-label ewLabel"><?php echo $mk->Nama->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $mk->Nama->CellAttributes() ?>>
<span id="el_mk_Nama">
<input type="text" data-table="mk" data-field="x_Nama" name="x_Nama" id="x_Nama" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($mk->Nama->getPlaceHolder()) ?>" value="<?php echo $mk->Nama->EditValue ?>"<?php echo $mk->Nama->EditAttributes() ?>>
</span>
<?php echo $mk->Nama->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_Nama">
		<td><span id="elh_mk_Nama"><?php echo $mk->Nama->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $mk->Nama->CellAttributes() ?>>
<span id="el_mk_Nama">
<input type="text" data-table="mk" data-field="x_Nama" name="x_Nama" id="x_Nama" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($mk->Nama->getPlaceHolder()) ?>" value="<?php echo $mk->Nama->EditValue ?>"<?php echo $mk->Nama->EditAttributes() ?>>
</span>
<?php echo $mk->Nama->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_Singkatan" class="form-group">
		<label id="elh_mk_Singkatan" for="x_Singkatan" class="col-sm-2 control-label ewLabel"><?php echo $mk->Singkatan->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->Singkatan->CellAttributes() ?>>
<span id="el_mk_Singkatan">
<input type="text" data-table="mk" data-field="x_Singkatan" name="x_Singkatan" id="x_Singkatan" size="7" maxlength="20" placeholder="<?php echo ew_HtmlEncode($mk->Singkatan->getPlaceHolder()) ?>" value="<?php echo $mk->Singkatan->EditValue ?>"<?php echo $mk->Singkatan->EditAttributes() ?>>
</span>
<?php echo $mk->Singkatan->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_Singkatan">
		<td><span id="elh_mk_Singkatan"><?php echo $mk->Singkatan->FldCaption() ?></span></td>
		<td<?php echo $mk->Singkatan->CellAttributes() ?>>
<span id="el_mk_Singkatan">
<input type="text" data-table="mk" data-field="x_Singkatan" name="x_Singkatan" id="x_Singkatan" size="7" maxlength="20" placeholder="<?php echo ew_HtmlEncode($mk->Singkatan->getPlaceHolder()) ?>" value="<?php echo $mk->Singkatan->EditValue ?>"<?php echo $mk->Singkatan->EditAttributes() ?>>
</span>
<?php echo $mk->Singkatan->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_Tingkat" class="form-group">
		<label id="elh_mk_Tingkat" class="col-sm-2 control-label ewLabel"><?php echo $mk->Tingkat->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $mk->Tingkat->CellAttributes() ?>>
<span id="el_mk_Tingkat">
<div id="tp_x_Tingkat" class="ewTemplate"><input type="checkbox" data-table="mk" data-field="x_Tingkat" data-value-separator="<?php echo $mk->Tingkat->DisplayValueSeparatorAttribute() ?>" name="x_Tingkat[]" id="x_Tingkat[]" value="{value}"<?php echo $mk->Tingkat->EditAttributes() ?>></div>
<div id="dsl_x_Tingkat" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $mk->Tingkat->CheckBoxListHtml(FALSE, "x_Tingkat[]") ?>
</div></div>
<input type="hidden" name="s_x_Tingkat" id="s_x_Tingkat" value="<?php echo $mk->Tingkat->LookupFilterQuery() ?>">
</span>
<?php echo $mk->Tingkat->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_Tingkat">
		<td><span id="elh_mk_Tingkat"><?php echo $mk->Tingkat->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $mk->Tingkat->CellAttributes() ?>>
<span id="el_mk_Tingkat">
<div id="tp_x_Tingkat" class="ewTemplate"><input type="checkbox" data-table="mk" data-field="x_Tingkat" data-value-separator="<?php echo $mk->Tingkat->DisplayValueSeparatorAttribute() ?>" name="x_Tingkat[]" id="x_Tingkat[]" value="{value}"<?php echo $mk->Tingkat->EditAttributes() ?>></div>
<div id="dsl_x_Tingkat" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $mk->Tingkat->CheckBoxListHtml(FALSE, "x_Tingkat[]") ?>
...
<?php echo $mk->Tingkat->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_Sesi" class="form-group">
		<label id="elh_mk_Sesi" for="x_Sesi" class="col-sm-2 control-label ewLabel"><?php echo $mk->Sesi->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->Sesi->CellAttributes() ?>>
<span id="el_mk_Sesi">
<select data-table="mk" data-field="x_Sesi" data-value-separator="<?php echo $mk->Sesi->DisplayValueSeparatorAttribute() ?>" id="x_Sesi" name="x_Sesi"<?php echo $mk->Sesi->EditAttributes() ?>>
<?php echo $mk->Sesi->SelectOptionListHtml("x_Sesi") ?>
</select>
<input type="hidden" name="s_x_Sesi" id="s_x_Sesi" value="<?php echo $mk->Sesi->LookupFilterQuery() ?>">
</span>
<?php echo $mk->Sesi->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_Sesi">
		<td><span id="elh_mk_Sesi"><?php echo $mk->Sesi->FldCaption() ?></span></td>
		<td<?php echo $mk->Sesi->CellAttributes() ?>>
<span id="el_mk_Sesi">
<select data-table="mk" data-field="x_Sesi" data-value-separator="<?php echo $mk->Sesi->DisplayValueSeparatorAttribute() ?>" id="x_Sesi" name="x_Sesi"<?php echo $mk->Sesi->EditAttributes() ?>>
<?php echo $mk->Sesi->SelectOptionListHtml("x_Sesi") ?>
</select>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_Wajib" class="form-group">
		<label id="elh_mk_Wajib" class="col-sm-2 control-label ewLabel"><?php echo $mk->Wajib->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->Wajib->CellAttributes() ?>>
<span id="el_mk_Wajib">
<div id="tp_x_Wajib" class="ewTemplate"><input type="radio" data-table="mk" data-field="x_Wajib" data-value-separator="<?php echo $mk->Wajib->DisplayValueSeparatorAttribute() ?>" name="x_Wajib" id="x_Wajib" value="{value}"<?php echo $mk->Wajib->EditAttributes() ?>></div>
<div id="dsl_x_Wajib" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $mk->Wajib->RadioButtonListHtml(FALSE, "x_Wajib") ?>
</div></div>
</span>
<?php echo $mk->Wajib->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_Wajib">
		<td><span id="elh_mk_Wajib"><?php echo $mk->Wajib->FldCaption() ?></span></td>
		<td<?php echo $mk->Wajib->CellAttributes() ?>>
<span id="el_mk_Wajib">
<div id="tp_x_Wajib" class="ewTemplate"><input type="radio" data-table="mk" data-field="x_Wajib" data-value-separator="<?php echo $mk->Wajib->DisplayValueSeparatorAttribute() ?>" name="x_Wajib" id="x_Wajib" value="{value}"<?php echo $mk->Wajib->EditAttributes() ?>></div>
<div id="dsl_x_Wajib" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $mk->Wajib->RadioButtonListHtml(FALSE, "x_Wajib") ?>
...
<?php echo $mk->Wajib->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_Deskripsi" class="form-group">
		<label id="elh_mk_Deskripsi" for="x_Deskripsi" class="col-sm-2 control-label ewLabel"><?php echo $mk->Deskripsi->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->Deskripsi->CellAttributes() ?>>
<span id="el_mk_Deskripsi">
<textarea data-table="mk" data-field="x_Deskripsi" name="x_Deskripsi" id="x_Deskripsi" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($mk->Deskripsi->getPlaceHolder()) ?>"<?php echo $mk->Deskripsi->EditAttributes() ?>><?php echo $mk->Deskripsi->EditValue ?></textarea>
</span>
<?php echo $mk->Deskripsi->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_Deskripsi">
		<td><span id="elh_mk_Deskripsi"><?php echo $mk->Deskripsi->FldCaption() ?></span></td>
		<td<?php echo $mk->Deskripsi->CellAttributes() ?>>
<span id="el_mk_Deskripsi">
<textarea data-table="mk" data-field="x_Deskripsi" name="x_Deskripsi" id="x_Deskripsi" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($mk->Deskripsi->getPlaceHolder()) ?>"<?php echo $mk->Deskripsi->EditAttributes() ?>><?php echo $mk->Deskripsi->EditValue ?></textarea>
</span>
<?php echo $mk->Deskripsi->CustomMsg ?></td>
	</tr>
<?php } ?>
<?php } ?>
...
<?php if (ew_IsMobile() || $mk_edit->IsModal) { ?>
	<div id="r_NA" class="form-group">
		<label id="elh_mk_NA" class="col-sm-2 control-label ewLabel"><?php echo $mk->NA->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $mk->NA->CellAttributes() ?>>
<span id="el_mk_NA">
<div id="tp_x_NA" class="ewTemplate"><input type="radio" data-table="mk" data-field="x_NA" data-value-separator="<?php echo $mk->NA->DisplayValueSeparatorAttribute() ?>" name="x_NA" id="x_NA" value="{value}"<?php echo $mk->NA->EditAttributes() ?>></div>
<div id="dsl_x_NA" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $mk->NA->RadioButtonListHtml(FALSE, "x_NA") ?>
</div></div>
</span>
<?php echo $mk->NA->CustomMsg ?></div></div>
	</div>
<?php } else { ?>
	<tr id="r_NA">
		<td><span id="elh_mk_NA"><?php echo $mk->NA->FldCaption() ?></span></td>
		<td<?php echo $mk->NA->CellAttributes() ?>>
<span id="el_mk_NA">
<div id="tp_x_NA" class="ewTemplate"><input type="radio" data-table="mk" data-field="x_NA" data-value-separator="<?php echo $mk->NA->DisplayValueSeparatorAttribute() ?>" name="x_NA" id="x_NA" value="{value}"<?php echo $mk->NA->EditAttributes() ?>></div>
<div id="dsl_x_NA" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $mk->NA->RadioButtonListHtml(FALSE, "x_NA") ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $mk_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
