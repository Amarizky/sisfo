...
<style type="text/css">
	#ewContentColumn{
		background-image: url("phpimages/education.jpg");
			    	...
			    	<form name="flogin" id="flogin" class="form-horizontal ewForm ewLoginForm" action="<?php echo ew_CurrentPage() ?>" method="post">
						...
						<?php } ?>
							<div class="form-group">
								...
								<div class="col-sm-12"><input type="text" name="username" id="username" class="form-control ewControl" style="width:100%;" value="<?php echo ew_HtmlEncode($login->Username) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Username")) ?>"></div>
							</div>
							<div class="form-group">
								
								<div class="col-sm-12"><input type="password" name="password" id="password" class="form-control ewControl" style="width:100%;" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Password")) ?>"></div>
							</div>
							<div class="form-group">
								<div class="col-sm-12">
