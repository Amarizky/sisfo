...
$master_sesi_add = NULL; // Initialize page object first

class cmaster_sesi_add extends cmaster_sesi {
	...
	// Page object name
	var $PageObjName = 'master_sesi_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "master_sesiview.php")
	...
	function LoadDefaultValues() {
		...
		$this->NamaSesi->CurrentValue = NULL;
		$this->NamaSesi->OldValue = $this->NamaSesi->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// NamaSesi
		$this->NamaSesi->SetDbValueDef($rsnew, $this->NamaSesi->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($master_sesi_add)) $master_sesi_add = new cmaster_sesi_add();

// Page init
$master_sesi_add->Page_Init();

// Page main
$master_sesi_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_sesi_add->Page_Render();
?>
...
var CurrentForm = fmaster_sesiadd = new ew_Form("fmaster_sesiadd", "add");

// Validate form
fmaster_sesiadd.Validate = function() {
...
fmaster_sesiadd.Form_CustomValidate = 
...
fmaster_sesiadd.ValidateRequired = true;
<?php } else { ?>
fmaster_sesiadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_sesiadd.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_sesiadd.Lists["x_NA"].Options = <?php echo json_encode($master_sesi->NA->Options()) ?>;
...
<?php if (!$master_sesi_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_sesi_add->ShowPageHeader(); ?>
<?php
$master_sesi_add->ShowMessage();
?>
<form name="fmaster_sesiadd" id="fmaster_sesiadd" class="<?php echo $master_sesi_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_sesi_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_sesi_add->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_sesi_add->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_sesi_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_sesiadd" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_sesi_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_sesiadd.Init();
</script>
<?php
$master_sesi_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_sesi_add->Page_Terminate();
?>
