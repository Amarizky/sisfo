...
define("EW_PROJECT_NAME", "sisfo_sekolah", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{B4ECA7F4-5928-4768-B0FE-A8227431E424}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '87VNMpgFpsB7g0ez', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/sisfo_sekolah.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "mrjf", "pass" => "Puspowarno@17", "db" => "sisfo", "qs" => "`", "qe" => "`");
