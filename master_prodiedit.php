...
$master_prodi_edit = NULL; // Initialize page object first

class cmaster_prodi_edit extends cmaster_prodi {
	...
	// Page object name
	var $PageObjName = 'master_prodi_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->ProdiID->CurrentValue == "") {
			$this->Page_Terminate("master_prodilist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Pejabat
			$this->Pejabat->SetDbValueDef($rsnew, $this->Pejabat->CurrentValue, NULL, $this->Pejabat->ReadOnly);

			// Keterangan
			$this->Keterangan->SetDbValueDef($rsnew, $this->Keterangan->CurrentValue, NULL, $this->Keterangan->ReadOnly);

			// Akreditasi
			$this->Akreditasi->SetDbValueDef($rsnew, $this->Akreditasi->CurrentValue, NULL, $this->Akreditasi->ReadOnly);

			// NoSK
			$this->NoSK->SetDbValueDef($rsnew, $this->NoSK->CurrentValue, NULL, $this->NoSK->ReadOnly);

			// TglSK
			$this->TglSK->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->TglSK->CurrentValue, 0), NULL, $this->TglSK->ReadOnly);
...
// Create page object
if (!isset($master_prodi_edit)) $master_prodi_edit = new cmaster_prodi_edit();

// Page init
$master_prodi_edit->Page_Init();

// Page main
$master_prodi_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_prodi_edit->Page_Render();
?>
...
var CurrentForm = fmaster_prodiedit = new ew_Form("fmaster_prodiedit", "edit");

// Validate form
fmaster_prodiedit.Validate = function() {
...
fmaster_prodiedit.Form_CustomValidate = 
...
fmaster_prodiedit.ValidateRequired = true;
<?php } else { ?>
fmaster_prodiedit.ValidateRequired = false; 
<?php } ?>

// Multi-Page
fmaster_prodiedit.MultiPage = new ew_MultiPage("fmaster_prodiedit");

// Dynamic selection lists
fmaster_prodiedit.Lists["x_Pejabat"] = {"LinkField":"x_TeacherID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"teacher"};
fmaster_prodiedit.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_prodiedit.Lists["x_NA"].Options = <?php echo json_encode($master_prodi->NA->Options()) ?>;
...
<?php if (!$master_prodi_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_prodi_edit->ShowPageHeader(); ?>
<?php
$master_prodi_edit->ShowMessage();
?>
<form name="fmaster_prodiedit" id="fmaster_prodiedit" class="<?php echo $master_prodi_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_prodi_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_prodi_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_prodi_edit->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<div class="ewMultiPage">
<div class="tabbable" id="master_prodi_edit">
	<ul class="nav<?php echo $master_prodi_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $master_prodi_edit->MultiPages->TabStyle("1") ?>><a href="#tab_master_prodi1" data-toggle="tab"><?php echo $master_prodi->PageCaption(1) ?></a></li>
		<li<?php echo $master_prodi_edit->MultiPages->TabStyle("2") ?>><a href="#tab_master_prodi2" data-toggle="tab"><?php echo $master_prodi->PageCaption(2) ?></a></li>
		<li<?php echo $master_prodi_edit->MultiPages->TabStyle("3") ?>><a href="#tab_master_prodi3" data-toggle="tab"><?php echo $master_prodi->PageCaption(3) ?></a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane<?php echo $master_prodi_edit->MultiPages->PageStyle("1") ?>" id="tab_master_prodi1">
<?php if (ew_IsMobile() || $master_prodi_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_prodiedit1" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<p class="form-control-static"><?php echo $master_prodi->ProdiID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="master_prodi" data-field="x_ProdiID" data-page="1" name="x_ProdiID" id="x_ProdiID" value="<?php echo ew_HtmlEncode($master_prodi->ProdiID->CurrentValue) ?>">
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $master_prodi_edit->MultiPages->PageStyle("2") ?>" id="tab_master_prodi2">
<?php if (ew_IsMobile() || $master_prodi_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_prodiedit2" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $master_prodi_edit->MultiPages->PageStyle("3") ?>" id="tab_master_prodi3">
<?php if (ew_IsMobile() || $master_prodi_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_prodiedit3" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_prodi_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_prodiedit.Init();
</script>
<?php
$master_prodi_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_prodi_edit->Page_Terminate();
?>
