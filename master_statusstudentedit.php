...
$master_statusstudent_edit = NULL; // Initialize page object first

class cmaster_statusstudent_edit extends cmaster_statusstudent {
	...
	// Page object name
	var $PageObjName = 'master_statusstudent_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->StatusStudentID->CurrentValue == "") {
			$this->Page_Terminate("master_statusstudentlist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// Keluar
			$this->Keluar->SetDbValueDef($rsnew, ((strval($this->Keluar->CurrentValue) == "Y") ? "Y" : "N"), "N", $this->Keluar->ReadOnly);
...
// Create page object
if (!isset($master_statusstudent_edit)) $master_statusstudent_edit = new cmaster_statusstudent_edit();

// Page init
$master_statusstudent_edit->Page_Init();

// Page main
$master_statusstudent_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_statusstudent_edit->Page_Render();
?>
...
var CurrentForm = fmaster_statusstudentedit = new ew_Form("fmaster_statusstudentedit", "edit");

// Validate form
fmaster_statusstudentedit.Validate = function() {
...
fmaster_statusstudentedit.Form_CustomValidate = 
...
fmaster_statusstudentedit.ValidateRequired = true;
<?php } else { ?>
fmaster_statusstudentedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_statusstudentedit.Lists["x_Keluar"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statusstudentedit.Lists["x_Keluar"].Options = <?php echo json_encode($master_statusstudent->Keluar->Options()) ?>;
fmaster_statusstudentedit.Lists["x_Def"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statusstudentedit.Lists["x_Def"].Options = <?php echo json_encode($master_statusstudent->Def->Options()) ?>;
fmaster_statusstudentedit.Lists["x_Lulus"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statusstudentedit.Lists["x_Lulus"].Options = <?php echo json_encode($master_statusstudent->Lulus->Options()) ?>;
fmaster_statusstudentedit.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_statusstudentedit.Lists["x_NA"].Options = <?php echo json_encode($master_statusstudent->NA->Options()) ?>;
...
<?php if (!$master_statusstudent_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $master_statusstudent_edit->ShowPageHeader(); ?>
<?php
$master_statusstudent_edit->ShowMessage();
?>
<form name="fmaster_statusstudentedit" id="fmaster_statusstudentedit" class="<?php echo $master_statusstudent_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_statusstudent_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_statusstudent_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_statusstudent_edit->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_statusstudent_edit->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_statusstudentedit" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<p class="form-control-static"><?php echo $master_statusstudent->StatusStudentID->EditValue ?></p></span>
</span>
<input type="hidden" data-table="master_statusstudent" data-field="x_StatusStudentID" name="x_StatusStudentID" id="x_StatusStudentID" value="<?php echo ew_HtmlEncode($master_statusstudent->StatusStudentID->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $master_statusstudent_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fmaster_statusstudentedit.Init();
</script>
<?php
$master_statusstudent_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_statusstudent_edit->Page_Terminate();
?>
