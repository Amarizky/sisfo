...
$master_jamkul_search = NULL; // Initialize page object first

class cmaster_jamkul_search extends cmaster_jamkul {
	...
	// Page object name
	var $PageObjName = 'master_jamkul_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "master_jamkullist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		...
		$this->BuildSearchUrl($sSrchUrl, $this->JamMulai); // JamMulai
		$this->BuildSearchUrl($sSrchUrl, $this->JamSelesai); // JamSelesai
	...
	function LoadSearchValues() {
		...
		// JamMulai
		$this->JamMulai->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_JamMulai"));
		$this->JamMulai->AdvancedSearch->SearchOperator = $objForm->GetValue("z_JamMulai");

		// JamSelesai
		$this->JamSelesai->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_JamSelesai"));
		$this->JamSelesai->AdvancedSearch->SearchOperator = $objForm->GetValue("z_JamSelesai");
	...
	function RenderRow() {
		...
		$this->NA->ViewCustomAttributes = "";
			...
			$this->JamID->EditValue = ew_HtmlEncode($this->JamID->AdvancedSearch->SearchValue);
			...
			$this->JamMulai->EditValue = ew_HtmlEncode(ew_UnFormatDateTime($this->JamMulai->AdvancedSearch->SearchValue, 0));
			...
			$this->JamSelesai->EditValue = ew_HtmlEncode(ew_UnFormatDateTime($this->JamSelesai->AdvancedSearch->SearchValue, 0));
	...
	function ValidateSearch() {
		...
		if (!EW_SERVER_VALIDATE)
			return TRUE;
		if (!ew_CheckTime($this->JamMulai->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->JamMulai->FldErrMsg());
		}
		if (!ew_CheckTime($this->JamSelesai->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->JamSelesai->FldErrMsg());
		}
...
// Create page object
if (!isset($master_jamkul_search)) $master_jamkul_search = new cmaster_jamkul_search();

// Page init
$master_jamkul_search->Page_Init();

// Page main
$master_jamkul_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$master_jamkul_search->Page_Render();
?>
...
<?php if ($master_jamkul_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fmaster_jamkulsearch = new ew_Form("fmaster_jamkulsearch", "search");
<?php } else { ?>
var CurrentForm = fmaster_jamkulsearch = new ew_Form("fmaster_jamkulsearch", "search");
<?php } ?>

// Form_CustomValidate event
fmaster_jamkulsearch.Form_CustomValidate = 
...
fmaster_jamkulsearch.ValidateRequired = true;
<?php } else { ?>
fmaster_jamkulsearch.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fmaster_jamkulsearch.Lists["x_HariID"] = {"LinkField":"x_HariID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_hari"};
fmaster_jamkulsearch.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaster_jamkulsearch.Lists["x_NA"].Options = <?php echo json_encode($master_jamkul->NA->Options()) ?>;

// Form object for search
// Validate function for search

fmaster_jamkulsearch.Validate = function(fobj) {
...
<?php } ?>
<?php $master_jamkul_search->ShowPageHeader(); ?>
<?php
$master_jamkul_search->ShowMessage();
?>
<form name="fmaster_jamkulsearch" id="fmaster_jamkulsearch" class="<?php echo $master_jamkul_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($master_jamkul_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $master_jamkul_search->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if (!ew_IsMobile() && !$master_jamkul_search->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $master_jamkul_search->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_master_jamkulsearch" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
<?php if ($master_jamkul->HariID->Visible) { // HariID ?>
<?php if (ew_IsMobile() || $master_jamkul_search->IsModal) { ?>
	<div id="r_HariID" class="form-group">
		<label for="x_HariID" class="<?php echo $master_jamkul_search->SearchLabelClass ?>"><span id="elh_master_jamkul_HariID"><?php echo $master_jamkul->HariID->FldCaption() ?></span>	
		...
		<div class="<?php echo $master_jamkul_search->SearchRightColumnClass ?>"><div<?php echo $master_jamkul->HariID->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_HariID">
		<td><span id="elh_master_jamkul_HariID"><?php echo $master_jamkul->HariID->FldCaption() ?></span></td>
...
<?php if (ew_IsMobile() || $master_jamkul_search->IsModal) { ?>
	<div id="r_JamID" class="form-group">
		<label for="x_JamID" class="<?php echo $master_jamkul_search->SearchLabelClass ?>"><span id="elh_master_jamkul_JamID"><?php echo $master_jamkul->JamID->FldCaption() ?></span>	
		...
		<div class="<?php echo $master_jamkul_search->SearchRightColumnClass ?>"><div<?php echo $master_jamkul->JamID->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_JamID">
		<td><span id="elh_master_jamkul_JamID"><?php echo $master_jamkul->JamID->FldCaption() ?></span></td>
...
<?php if (ew_IsMobile() || $master_jamkul_search->IsModal) { ?>
	<div id="r_JamMulai" class="form-group">
		<label for="x_JamMulai" class="<?php echo $master_jamkul_search->SearchLabelClass ?>"><span id="elh_master_jamkul_JamMulai"><?php echo $master_jamkul->JamMulai->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_JamMulai" id="z_JamMulai" value="="></p>
		</label>
		<div class="<?php echo $master_jamkul_search->SearchRightColumnClass ?>"><div<?php echo $master_jamkul->JamMulai->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_JamMulai">
		...
		<td><span class="ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_JamMulai" id="z_JamMulai" value="="></span></td>
...
<?php if (ew_IsMobile() || $master_jamkul_search->IsModal) { ?>
	<div id="r_JamSelesai" class="form-group">
		<label for="x_JamSelesai" class="<?php echo $master_jamkul_search->SearchLabelClass ?>"><span id="elh_master_jamkul_JamSelesai"><?php echo $master_jamkul->JamSelesai->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_JamSelesai" id="z_JamSelesai" value="="></p>
		</label>
		<div class="<?php echo $master_jamkul_search->SearchRightColumnClass ?>"><div<?php echo $master_jamkul->JamSelesai->CellAttributes() ?>>
...
<?php } else { ?>
	<tr id="r_JamSelesai">
		...
		<td><span class="ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_JamSelesai" id="z_JamSelesai" value="="></span></td>
...
<?php if (ew_IsMobile() || $master_jamkul_search->IsModal) { ?>
	<div id="r_NA" class="form-group">
		<label class="<?php echo $master_jamkul_search->SearchLabelClass ?>"><span id="elh_master_jamkul_NA"><?php echo $master_jamkul->NA->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_NA" id="z_NA" value="="></p>
		</label>
		<div class="<?php echo $master_jamkul_search->SearchRightColumnClass ?>"><div<?php echo $master_jamkul->NA->CellAttributes() ?>>
...
<script type="text/javascript">
fmaster_jamkulsearch.Init();
</script>
<?php
$master_jamkul_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$master_jamkul_search->Page_Terminate();
?>
