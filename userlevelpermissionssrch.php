...
<?php } ?>
<?php if (!ew_IsMobile() && !$userlevelpermissions_search->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<?php if (ew_IsMobile() || $userlevelpermissions_search->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_userlevelpermissionssearch" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<?php } else { ?>
	<tr id="r__tablename">
		...
		<td><span class="ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z__tablename" id="z__tablename" value="LIKE"></span></td>
...
<?php } else { ?>
	<tr id="r_permission">
		...
		<td><span class="ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_permission" id="z_permission" value="="></span></td>
