...
class cstudent_add extends cstudent {
	...
	function LoadDefaultValues() {
		...
		$this->WargaNegara->CurrentValue = NULL;
		$this->WargaNegara->OldValue = $this->WargaNegara->CurrentValue;
		...
		$this->Darah->CurrentValue = NULL;
		$this->Darah->OldValue = $this->Darah->CurrentValue;
		$this->StatusSipil->CurrentValue = NULL;
		$this->StatusSipil->OldValue = $this->StatusSipil->CurrentValue;
		...
		$this->AnakKe->CurrentValue = NULL;
		$this->AnakKe->OldValue = $this->AnakKe->CurrentValue;
		$this->JumlahSaudara->CurrentValue = NULL;
		$this->JumlahSaudara->OldValue = $this->JumlahSaudara->CurrentValue;
		$this->Telepon->CurrentValue = NULL;
		$this->Telepon->OldValue = $this->Telepon->CurrentValue;
		$this->_Email->CurrentValue = NULL;
		$this->_Email->OldValue = $this->_Email->CurrentValue;
		$this->NamaAyah->CurrentValue = NULL;
		$this->NamaAyah->OldValue = $this->NamaAyah->CurrentValue;
		$this->AgamaAyah->CurrentValue = NULL;
		$this->AgamaAyah->OldValue = $this->AgamaAyah->CurrentValue;
		$this->PendidikanAyah->CurrentValue = NULL;
		$this->PendidikanAyah->OldValue = $this->PendidikanAyah->CurrentValue;
		$this->PekerjaanAyah->CurrentValue = NULL;
		$this->PekerjaanAyah->OldValue = $this->PekerjaanAyah->CurrentValue;
		$this->HidupAyah->CurrentValue = NULL;
		$this->HidupAyah->OldValue = $this->HidupAyah->CurrentValue;
		$this->NamaIbu->CurrentValue = NULL;
		$this->NamaIbu->OldValue = $this->NamaIbu->CurrentValue;
		$this->AgamaIbu->CurrentValue = NULL;
		$this->AgamaIbu->OldValue = $this->AgamaIbu->CurrentValue;
		$this->PendidikanIbu->CurrentValue = NULL;
		$this->PendidikanIbu->OldValue = $this->PendidikanIbu->CurrentValue;
		$this->PekerjaanIbu->CurrentValue = NULL;
		$this->PekerjaanIbu->OldValue = $this->PekerjaanIbu->CurrentValue;
		$this->HidupIbu->CurrentValue = NULL;
		$this->HidupIbu->OldValue = $this->HidupIbu->CurrentValue;
		$this->AlamatOrtu->CurrentValue = NULL;
		$this->AlamatOrtu->OldValue = $this->AlamatOrtu->CurrentValue;
		$this->RTOrtu->CurrentValue = NULL;
		$this->RTOrtu->OldValue = $this->RTOrtu->CurrentValue;
		$this->RWOrtu->CurrentValue = NULL;
		$this->RWOrtu->OldValue = $this->RWOrtu->CurrentValue;
		$this->KodePosOrtu->CurrentValue = NULL;
		$this->KodePosOrtu->OldValue = $this->KodePosOrtu->CurrentValue;
		$this->ProvinsiIDOrtu->CurrentValue = NULL;
		$this->ProvinsiIDOrtu->OldValue = $this->ProvinsiIDOrtu->CurrentValue;
		$this->KabupatenIDOrtu->CurrentValue = NULL;
		$this->KabupatenIDOrtu->OldValue = $this->KabupatenIDOrtu->CurrentValue;
		$this->KecamatanIDOrtu->CurrentValue = NULL;
		$this->KecamatanIDOrtu->OldValue = $this->KecamatanIDOrtu->CurrentValue;
		$this->DesaIDOrtu->CurrentValue = NULL;
		$this->DesaIDOrtu->OldValue = $this->DesaIDOrtu->CurrentValue;
		$this->NegaraIDOrtu->CurrentValue = NULL;
		$this->NegaraIDOrtu->OldValue = $this->NegaraIDOrtu->CurrentValue;
		$this->TeleponOrtu->CurrentValue = NULL;
		$this->TeleponOrtu->OldValue = $this->TeleponOrtu->CurrentValue;
		$this->HandphoneOrtu->CurrentValue = NULL;
		$this->HandphoneOrtu->OldValue = $this->HandphoneOrtu->CurrentValue;
		$this->EmailOrtu->CurrentValue = NULL;
		$this->EmailOrtu->OldValue = $this->EmailOrtu->CurrentValue;
		$this->AsalSekolah->CurrentValue = NULL;
		$this->AsalSekolah->OldValue = $this->AsalSekolah->CurrentValue;
		$this->AlamatSekolah->CurrentValue = NULL;
		$this->AlamatSekolah->OldValue = $this->AlamatSekolah->CurrentValue;
		$this->ProvinsiIDSekolah->CurrentValue = NULL;
		$this->ProvinsiIDSekolah->OldValue = $this->ProvinsiIDSekolah->CurrentValue;
		$this->KabupatenIDSekolah->CurrentValue = NULL;
		$this->KabupatenIDSekolah->OldValue = $this->KabupatenIDSekolah->CurrentValue;
		$this->KecamatanIDSekolah->CurrentValue = NULL;
		$this->KecamatanIDSekolah->OldValue = $this->KecamatanIDSekolah->CurrentValue;
		$this->DesaIDSekolah->CurrentValue = NULL;
		$this->DesaIDSekolah->OldValue = $this->DesaIDSekolah->CurrentValue;
		$this->NilaiSekolah->CurrentValue = NULL;
		$this->NilaiSekolah->OldValue = $this->NilaiSekolah->CurrentValue;
		$this->TahunLulus->CurrentValue = NULL;
		$this->TahunLulus->OldValue = $this->TahunLulus->CurrentValue;
		$this->IjazahSekolah->CurrentValue = NULL;
		$this->IjazahSekolah->OldValue = $this->IjazahSekolah->CurrentValue;
		$this->TglIjazah->CurrentValue = "0000-00-00";
	...
	function AddRow($rsold = NULL) {
		...
		// WargaNegara
		$this->WargaNegara->SetDbValueDef($rsnew, $this->WargaNegara->CurrentValue, NULL, FALSE);
		...
		// Darah
		$this->Darah->SetDbValueDef($rsnew, $this->Darah->CurrentValue, NULL, strval($this->Darah->CurrentValue) == "");

		// StatusSipil
		$this->StatusSipil->SetDbValueDef($rsnew, $this->StatusSipil->CurrentValue, NULL, FALSE);
		...
		// AnakKe
		$this->AnakKe->SetDbValueDef($rsnew, $this->AnakKe->CurrentValue, NULL, FALSE);

		// JumlahSaudara
		$this->JumlahSaudara->SetDbValueDef($rsnew, $this->JumlahSaudara->CurrentValue, NULL, FALSE);
		...
		// NamaAyah
		$this->NamaAyah->SetDbValueDef($rsnew, $this->NamaAyah->CurrentValue, NULL, FALSE);

		// AgamaAyah
		$this->AgamaAyah->SetDbValueDef($rsnew, $this->AgamaAyah->CurrentValue, NULL, FALSE);

		// PendidikanAyah
		$this->PendidikanAyah->SetDbValueDef($rsnew, $this->PendidikanAyah->CurrentValue, NULL, FALSE);

		// PekerjaanAyah
		$this->PekerjaanAyah->SetDbValueDef($rsnew, $this->PekerjaanAyah->CurrentValue, NULL, FALSE);

		// HidupAyah
		$this->HidupAyah->SetDbValueDef($rsnew, $this->HidupAyah->CurrentValue, NULL, FALSE);

		// NamaIbu
		$this->NamaIbu->SetDbValueDef($rsnew, $this->NamaIbu->CurrentValue, NULL, FALSE);

		// AgamaIbu
		$this->AgamaIbu->SetDbValueDef($rsnew, $this->AgamaIbu->CurrentValue, NULL, FALSE);

		// PendidikanIbu
		$this->PendidikanIbu->SetDbValueDef($rsnew, $this->PendidikanIbu->CurrentValue, NULL, FALSE);

		// PekerjaanIbu
		$this->PekerjaanIbu->SetDbValueDef($rsnew, $this->PekerjaanIbu->CurrentValue, NULL, FALSE);

		// HidupIbu
		$this->HidupIbu->SetDbValueDef($rsnew, $this->HidupIbu->CurrentValue, NULL, FALSE);

		// AlamatOrtu
		$this->AlamatOrtu->SetDbValueDef($rsnew, $this->AlamatOrtu->CurrentValue, NULL, FALSE);

		// RTOrtu
		$this->RTOrtu->SetDbValueDef($rsnew, $this->RTOrtu->CurrentValue, NULL, FALSE);

		// RWOrtu
		$this->RWOrtu->SetDbValueDef($rsnew, $this->RWOrtu->CurrentValue, NULL, FALSE);

		// KodePosOrtu
		$this->KodePosOrtu->SetDbValueDef($rsnew, $this->KodePosOrtu->CurrentValue, NULL, FALSE);

		// ProvinsiIDOrtu
		$this->ProvinsiIDOrtu->SetDbValueDef($rsnew, $this->ProvinsiIDOrtu->CurrentValue, NULL, FALSE);

		// KabupatenIDOrtu
		$this->KabupatenIDOrtu->SetDbValueDef($rsnew, $this->KabupatenIDOrtu->CurrentValue, NULL, FALSE);

		// KecamatanIDOrtu
		$this->KecamatanIDOrtu->SetDbValueDef($rsnew, $this->KecamatanIDOrtu->CurrentValue, NULL, FALSE);

		// DesaIDOrtu
		$this->DesaIDOrtu->SetDbValueDef($rsnew, $this->DesaIDOrtu->CurrentValue, NULL, FALSE);

		// NegaraIDOrtu
		$this->NegaraIDOrtu->SetDbValueDef($rsnew, $this->NegaraIDOrtu->CurrentValue, NULL, FALSE);

		// TeleponOrtu
		$this->TeleponOrtu->SetDbValueDef($rsnew, $this->TeleponOrtu->CurrentValue, NULL, FALSE);

		// HandphoneOrtu
		$this->HandphoneOrtu->SetDbValueDef($rsnew, $this->HandphoneOrtu->CurrentValue, NULL, FALSE);

		// EmailOrtu
		$this->EmailOrtu->SetDbValueDef($rsnew, $this->EmailOrtu->CurrentValue, NULL, FALSE);

		// AsalSekolah
		$this->AsalSekolah->SetDbValueDef($rsnew, $this->AsalSekolah->CurrentValue, NULL, FALSE);

		// AlamatSekolah
		$this->AlamatSekolah->SetDbValueDef($rsnew, $this->AlamatSekolah->CurrentValue, NULL, FALSE);

		// ProvinsiIDSekolah
		$this->ProvinsiIDSekolah->SetDbValueDef($rsnew, $this->ProvinsiIDSekolah->CurrentValue, NULL, FALSE);

		// KabupatenIDSekolah
		$this->KabupatenIDSekolah->SetDbValueDef($rsnew, $this->KabupatenIDSekolah->CurrentValue, NULL, FALSE);

		// KecamatanIDSekolah
		$this->KecamatanIDSekolah->SetDbValueDef($rsnew, $this->KecamatanIDSekolah->CurrentValue, NULL, FALSE);

		// DesaIDSekolah
		$this->DesaIDSekolah->SetDbValueDef($rsnew, $this->DesaIDSekolah->CurrentValue, NULL, FALSE);

		// NilaiSekolah
		$this->NilaiSekolah->SetDbValueDef($rsnew, $this->NilaiSekolah->CurrentValue, NULL, FALSE);

		// TahunLulus
		$this->TahunLulus->SetDbValueDef($rsnew, $this->TahunLulus->CurrentValue, NULL, FALSE);

		// IjazahSekolah
		$this->IjazahSekolah->SetDbValueDef($rsnew, $this->IjazahSekolah->CurrentValue, NULL, FALSE);

		// TglIjazah
		$this->TglIjazah->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->TglIjazah->CurrentValue, 0), NULL, FALSE);
...
// Multi-Page
fstudentadd.MultiPage = new ew_MultiPage("fstudentadd");

// Dynamic selection lists
fstudentadd.Lists["x_KampusID"] = {"LinkField":"x_KampusID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_kampus"};
fstudentadd.Lists["x_ProdiID"] = {"LinkField":"x_ProdiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_prodi"};
fstudentadd.Lists["x_StudentStatusID"] = {"LinkField":"x_StatusStudentID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_statusstudent"};
fstudentadd.Lists["x_WargaNegara"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstudentadd.Lists["x_WargaNegara"].Options = <?php echo json_encode($student->WargaNegara->Options()) ?>;
fstudentadd.Lists["x_Kelamin"] = {"LinkField":"x_Kelamin","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_kelamin"};
fstudentadd.Lists["x_AgamaID"] = {"LinkField":"x_AgamaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_agama"};
fstudentadd.Lists["x_Darah"] = {"LinkField":"x_DarahID","Ajax":true,"AutoFill":false,"DisplayFields":["x_DarahID","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_darah"};
fstudentadd.Lists["x_StatusSipil"] = {"LinkField":"x_StatusSipil","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_statussipil"};
fstudentadd.Lists["x_ProvinsiID"] = {"LinkField":"x_ProvinsiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Provinsi","","",""],"ParentFields":[],"ChildFields":["x_KabupatenKotaID"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_provinsi"};
fstudentadd.Lists["x_KabupatenKotaID"] = {"LinkField":"x_KabupatenKotaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_KabupatenKota","","",""],"ParentFields":["x_ProvinsiID"],"ChildFields":["x_KecamatanID"],"FilterFields":["x_ProvinsiID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kabupatenkota"};
fstudentadd.Lists["x_KecamatanID"] = {"LinkField":"x_KecamatanID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Kecamatan","","",""],"ParentFields":["x_KabupatenKotaID"],"ChildFields":["x_DesaID"],"FilterFields":["x_KabupatenKotaID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kecamatan"};
fstudentadd.Lists["x_DesaID"] = {"LinkField":"x_DesaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Desa","","",""],"ParentFields":["x_KecamatanID"],"ChildFields":[],"FilterFields":["x_KecamatanID"],"Options":[],"Template":"","LinkTable":"master_wilayah_desa"};
fstudentadd.Lists["x_AgamaAyah"] = {"LinkField":"x_AgamaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_agama"};
fstudentadd.Lists["x_PendidikanAyah"] = {"LinkField":"x_Pendidikan","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_pendidikanortu"};
fstudentadd.Lists["x_PekerjaanAyah"] = {"LinkField":"x_Pekerjaan","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_pekerjaanortu"};
fstudentadd.Lists["x_HidupAyah"] = {"LinkField":"x_Hidup","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_hidup"};
fstudentadd.Lists["x_AgamaIbu"] = {"LinkField":"x_AgamaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_agama"};
fstudentadd.Lists["x_PendidikanIbu"] = {"LinkField":"x_Pendidikan","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_pendidikanortu"};
fstudentadd.Lists["x_PekerjaanIbu"] = {"LinkField":"x_Pekerjaan","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_pekerjaanortu"};
fstudentadd.Lists["x_HidupIbu"] = {"LinkField":"x_Hidup","Ajax":true,"AutoFill":false,"DisplayFields":["x_Nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_hidup"};
fstudentadd.Lists["x_ProvinsiIDOrtu"] = {"LinkField":"x_ProvinsiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Provinsi","","",""],"ParentFields":[],"ChildFields":["x_KabupatenIDOrtu"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_provinsi"};
fstudentadd.Lists["x_KabupatenIDOrtu"] = {"LinkField":"x_KabupatenKotaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_KabupatenKota","","",""],"ParentFields":["x_ProvinsiIDOrtu"],"ChildFields":["x_KecamatanIDOrtu"],"FilterFields":["x_ProvinsiID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kabupatenkota"};
fstudentadd.Lists["x_KecamatanIDOrtu"] = {"LinkField":"x_KecamatanID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Kecamatan","","",""],"ParentFields":["x_KabupatenIDOrtu"],"ChildFields":["x_DesaIDOrtu"],"FilterFields":["x_KabupatenKotaID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kecamatan"};
fstudentadd.Lists["x_DesaIDOrtu"] = {"LinkField":"x_DesaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Desa","","",""],"ParentFields":["x_KecamatanIDOrtu"],"ChildFields":[],"FilterFields":["x_KecamatanID"],"Options":[],"Template":"","LinkTable":"master_wilayah_desa"};
fstudentadd.Lists["x_NegaraIDOrtu"] = {"LinkField":"x_NegaraID","Ajax":true,"AutoFill":false,"DisplayFields":["x_NamaNegara","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_negara"};
fstudentadd.Lists["x_ProvinsiIDSekolah"] = {"LinkField":"x_ProvinsiID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Provinsi","","",""],"ParentFields":[],"ChildFields":["x_KabupatenIDSekolah"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"master_wilayah_provinsi"};
fstudentadd.Lists["x_KabupatenIDSekolah"] = {"LinkField":"x_KabupatenKotaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_KabupatenKota","","",""],"ParentFields":["x_ProvinsiIDSekolah"],"ChildFields":["x_KecamatanIDSekolah"],"FilterFields":["x_ProvinsiID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kabupatenkota"};
fstudentadd.Lists["x_KecamatanIDSekolah"] = {"LinkField":"x_KecamatanID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Kecamatan","","",""],"ParentFields":["x_KabupatenIDSekolah"],"ChildFields":["x_DesaIDSekolah"],"FilterFields":["x_KabupatenKotaID"],"Options":[],"Template":"","LinkTable":"master_wilayah_kecamatan"};
fstudentadd.Lists["x_DesaIDSekolah"] = {"LinkField":"x_DesaID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Desa","","",""],"ParentFields":["x_KecamatanIDSekolah"],"ChildFields":[],"FilterFields":["x_KecamatanID"],"Options":[],"Template":"","LinkTable":"master_wilayah_desa"};
fstudentadd.Lists["x_NA"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstudentadd.Lists["x_NA"].Options = <?php echo json_encode($student->NA->Options()) ?>;
...
<?php } ?>
<?php if (!ew_IsMobile() && !$student_add->IsModal) { ?>
<div class="ewDesktop">
<?php } ?>
<div class="ewMultiPage">
<div class="tabbable" id="student_add">
	<ul class="nav<?php echo $student_add->MultiPages->NavStyle() ?>">
		<li<?php echo $student_add->MultiPages->TabStyle("1") ?>><a href="#tab_student1" data-toggle="tab"><?php echo $student->PageCaption(1) ?></a></li>
		<li<?php echo $student_add->MultiPages->TabStyle("2") ?>><a href="#tab_student2" data-toggle="tab"><?php echo $student->PageCaption(2) ?></a></li>
		<li<?php echo $student_add->MultiPages->TabStyle("3") ?>><a href="#tab_student3" data-toggle="tab"><?php echo $student->PageCaption(3) ?></a></li>
		<li<?php echo $student_add->MultiPages->TabStyle("4") ?>><a href="#tab_student4" data-toggle="tab"><?php echo $student->PageCaption(4) ?></a></li>
		<li<?php echo $student_add->MultiPages->TabStyle("5") ?>><a href="#tab_student5" data-toggle="tab"><?php echo $student->PageCaption(5) ?></a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane<?php echo $student_add->MultiPages->PageStyle("1") ?>" id="tab_student1">
<?php if (ew_IsMobile() || $student_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_studentadd1" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<input type="password" data-field="x_Password" name="x_Password" id="x_Password" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($student->Password->getPlaceHolder()) ?>"<?php echo $student->Password->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $student_add->MultiPages->PageStyle("2") ?>" id="tab_student2">
<?php if (ew_IsMobile() || $student_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_studentadd2" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $student_add->MultiPages->PageStyle("3") ?>" id="tab_student3">
<?php if (ew_IsMobile() || $student_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_studentadd3" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $student_add->MultiPages->PageStyle("4") ?>" id="tab_student4">
<?php if (ew_IsMobile() || $student_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_studentadd4" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $student_add->MultiPages->PageStyle("5") ?>" id="tab_student5">
<?php if (ew_IsMobile() || $student_add->IsModal) { ?>
<div>
<?php } else { ?>
<div>
<table id="tbl_studentadd5" class="table table-bordered table-striped ewDesktopTable">
<?php } ?>
